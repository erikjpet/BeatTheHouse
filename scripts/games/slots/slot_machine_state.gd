...
static func _normalize_active_bonus(value: Variant) -> Dictionary:
	...
	active["pinball_summary"] = _copy_dict(active.get("pinball_summary", {}))
	active["pinball_view"] = _copy_dict(active.get("pinball_view", {}))
	active["pinball_item_effects"] = _copy_dict(active.get("pinball_item_effects", {}))
	active["pinball_item_hooks"] = _copy_array(active.get("pinball_item_hooks", []))
	active["sequencer_state"] = _copy_dict(active.get("sequencer_state", {}))
	active["sequence_events"] = _copy_array(active.get("sequence_events", []))
	active["lit"] = _copy_dict(active.get("lit", {}))
	active["combo_state"] = _copy_dict(active.get("combo_state", {}))
	active["pinball_debug"] = _copy_dict(active.get("pinball_debug", {}))

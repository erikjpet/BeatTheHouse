...
# Captures full serialized bytes at ordinary generation boundaries. The checked-in
# fixture is produced from accepted pre-crew06_5 main and compared byte-for-byte.

...
- Windowed guided proof capture — **PASS**, 23 authoritative PNGs emitted by
  the final run under `.tmp/tutorial_playtest_fixes/captures/`; only the
  filenames listed above are used as proof.

...
passed. Six 2026-09-23 current-main exploratory clean probes then accepted PLAY
...
coordinates were injected into the root Viewport. Every failure happened before
a route economy decision and is a replay-policy/bridge finding, not product

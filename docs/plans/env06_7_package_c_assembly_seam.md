...
> The immutable handoff below records the historical rejected candidate. The
> ordered production recovery supersedes its validation status; see
> `env06_7_package_c_ordered_recovery.md`.

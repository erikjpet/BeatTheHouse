...
|---|---|---|---|
| pre-game-depth | `31e434c412ba8bdeda03bee86db1f8b4d899c962` | first parent of accepted game ritual merge `5a2b1e1a6782a13308585e1a974adeeb86be0647` | seed `INTEG06-1-MID06-PRE-GAME-006`; travel to Gas Station Casino, open its generated Slot, execute a public spin, and require persisted `spin_count >= 1` plus a result |

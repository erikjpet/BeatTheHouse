...
| Exact solver-produced coordinates | Every room coordinate is an authored slot sealed by `slot_id`, map digest, class, hit rect, label anchor, facing, and support. Renderer and action authority share it. |

...
- Endings — Lane B 2026-09-24 19:23 CT. Works now: the allowed normal-play confirmation path runs in an isolated profile, buys Grand chips through Linda's immediate service action, dismisses a selected room card through one real blank-room click, and reaches the capped-map Corner Store through visible travel cards before accepting the Crew marker. The crowded-room Open Map path now follows the full visible overflow list. Next: finish the active Crew/Heist confirmation, then take Clean and Cheat to their win screens and save all three owner screenshots.

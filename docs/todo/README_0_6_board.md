...
| game06_4 | `game06_4_machine_games_depth_prompt.md` | CLAIMING — CONTRACT-ONLY / REJECTED RUNTIME FORBIDDEN | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad MACHINE-GAMES | 2026-08-27 | — | Former game06_1 squad rotates here rather than idle. Dedicated branch/worktree must base directly on frozen contract, own row-local machine-game files/tests/docs only, and commit UNREVIEWED WIP within 30 minutes. No rejected game06_1 runtime may enter ancestry or authority. |
...
| world06_3 | `world06_3_numbers_depth_prompt.md` | IN_PROGRESS — INDEPENDENT MODEL PACKAGE | world06_1/world06_2 for route/adapter integration, review and landing; independent Numbers model package authorized | — | Codex/lane:world06_3 | 2026-08-27 | — | Implement only NumbersModel-owned physical slip/bookmaker/draw/fix state, closed action receipts, and focused pure-model contracts. Do not create route, adapter, EventModule, or receipt authority while world06_1/world06_2 remain parked. |

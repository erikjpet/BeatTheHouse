...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | PARTIAL PRODUCT ACCEPTED / REPLAY DOCS IN REVIEW | crew06_2/5/6/9; env06_6b for landing; accepted game ritual authority successor | depth06_1 | former env/world lane; Primary Integrator | 2026-08-27 | — | Primary ACCEPTED exact partial `33999772`/tree `f9574c47` within the proposal-only/fail-closed boundary; second review consumed. Immutable docs replay manifest exact `8f954f69`/tree `c0072587` is in formal custody review and binds exact missing game06_1/env roots, assembly order, hostile matrices and all held gates. Authentic memory/tell/interrupt roots and env/visual/Web/accessibility/performance/full integration remain blocked; no row, gate or landing acceptance. |

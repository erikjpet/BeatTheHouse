...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fix06_28 | `fix06_28_playtest_blocking_interaction_and_surface_pass_prompt.md` | IN_PROGRESS | owner playtest | playable 0.6 owner build | `/root` | 2026-09-07 | — | P0 owner-playtest blocker: make every accepted action visibly acknowledge and change the room/event/economy, restore trustworthy slot and machine-surface validation, explain the false-green acceptance gap, and complete a production-host working-order pass before producing a local Windows build. Absorbs `env06_9`. |
...
| env06_9 | `env06_9_visual_consequence_and_object_identity_prompt.md` | IN_PROGRESS | owner playtest / acceptance-bar decision | fix06_28 | `/root` via fix06_28 | 2026-09-07 | — | Unparked and absorbed into P0 `fix06_28` by owner playtest. Binding default: enough room-visible state change and object identity for a player to distinguish objects and recognize accepted actions; full per-object art parity remains an open owner-scope question and is not inferred. |

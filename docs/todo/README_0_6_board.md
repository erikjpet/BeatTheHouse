...
| fix06_5 | `fix06_5_contract_timing_measurement_prompt.md` | IN_PROGRESS | — | reliable Contract timing guard | PM:Codex/sub:preflight_inventory | 2026-08-26 | — | Five-run same-head idle-host measurement claimed and predeclared at exact source `e75f2c3d`; no run has executed and no stale-baseline conclusion or cap change is claimed. All attempts/results and historical 213.643/231.531/261.805/261.650/259.847s evidence must remain visible; median decision rule and native/host eligibility are binding. Does not block other rows. |

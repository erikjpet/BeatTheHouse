...
| fix06_13 | `fix06_13_coin_pusher_shipped_web_performance_prompt.md` | FUNCTIONAL RED — INLINE LEAK REMEDIATION ACTIVE | accepted fix06_9 evidence remediation; fix06_14/16 DONE | fix06_9, pusherv3_11 closure | Squad FIX06_13; Second Integrator | 2026-08-27 | — | Exact integration `62d45c2e` passed review, validation/import/load 55.988/45.836/25.556s and all focused assertions, but functional qualification failed after 173.107s on retained stderr `ObjectDB instances leaked at exit` plus one resource still in use; wrapper exit127. Exact evidence is preserved, no rerun, and the locked Web result remains unconsumed. Landing-blocking cleanup is routed inline in this row—no new infra row, weakening or local expensive gate. |
...
| balance06_1-follow-on | `balance06_1_follow_on_cross_system_economy_audit_prompt.md` | CONTRACT REVIEW QUEUED / DEPENDENCY-HELD | Families 1 and 2 merged | playtest06_2 | Contract Author; Second Integrator | 2026-08-28 | — | This is the reconciled 29th program row. Docs-only prompt exact `1e722344`/tree `c2e20573` materializes the deferred 64-seed × 8-playstyle combined distributions, 200k accepted paid drops per machine/600k combined pusher EV, findings and option-neutral proposals. It preserves locked economy/RNG/tuning and binds exact-tree/hostile/privacy/native-Web/save/migration/composition/quiesced-performance/anti-loss handoff without product, gate, claim or release authority. Independent contract review is queued. |

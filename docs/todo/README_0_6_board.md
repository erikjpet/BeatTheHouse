...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | PARTIAL SUCCESSOR IN SECOND REVIEW / DEPENDENCY-HELD | crew06_2/5/6/9; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | former env/world lane; Primary Integrator | 2026-08-27 | — | Exact partial successor `33999772`/tree `f9574c47`, two-file delta over rejected `678c3e27`, is in the row's second ordinary review. It closes ordered NPC continuation after player fold and hidden exclusion; raw interrupts are proposal-only/no-op; caller-mintable transactions cannot authorize memory/tells; absent authentic roots fail closed with named gaps; hostile/profile/raise/fold/forged-restore matrices are added. Authentic game06_1/env poker memory/tell/interrupt authority plus visual/Web/accessibility/performance/full integration remain held. No full-row claim; rejection escalates. |

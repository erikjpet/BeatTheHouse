...
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS | frozen env06_6 `855a2961` | depth06_1 | Squads A-E + assembly: `codex/env06_7-pkg-a`..`-e`, `codex/env06_7-assembly`; A active | 2026-08-27 | — | Five archetype packages cover all 55 ids exactly once; assembly exclusively owns shared catalog/index/pixel canvas/cross-seam fixtures. Package A first product commit `417c2c5c`; B-E/assembly have named branches/worktrees and rotate into the hard concurrency slots under the 30-minute anti-loss rule. |
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | IN_PROGRESS | craps06_1/2; frozen env06_6 `855a2961`; owner-frozen game ritual contract | depth06_1 | Squad CRAPS06_3 — `codex/craps06_3-impl` | 2026-08-27 | — | Product implementation active in `C:\bth-craps06_3`; tactile ritual/settlement, wager controls, actors, energy and Street sequence. Shared-file changes route through assigned integrators. |
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | TODO — ASSIGNED | crew06_2/5/6/9; frozen env06_6 `855a2961`; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `codex/crew06_10-impl` (queued for next hard slot) | 2026-08-27 | — | Named branch/worktree exists at `C:\bth-crew06_10`; implementation assignment is binding. Start is waiting only on the hard agent-concurrency ceiling; no crew/world model ownership transfers. |

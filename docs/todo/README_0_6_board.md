...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| env06_6 | `env06_6_dynamic_scenario_runtime_prompt.md` | IN_PROGRESS — FEATURE-FROZEN / CONTRACT RED | env06_1/2/3/5 (DONE) | env06_7, craps06_3, crew06_10, world06_1 landing | PM:Codex/sub:runtime-owner; dedicated Integrator | 2026-08-25 | — | Integrator exact head `9d3cada4`: validation/import/load pass, but `foundation_contracts` has 84 functional failures in 456.796s versus 230.391s. Only changes strictly required to eliminate this current red may enter env06_6; hardening, sealing, and improvements defer to separately claimed post-land rows. Evidence: `C:\bth-env06_6-gate-9d3cada4\.tmp\integrator_contract_9d3cada4\summary.json`. |
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS — PACKAGES A/B/D FIRST REJECTION | accepted env06_6 successor plus ordered real catalog authority | depth06_1 | Squads A-E + ordered assembly; all branches preserved | 2026-08-27 | — | First rejections: A `599e7f56` metadata-only world facts/non-executable proof; B `b1c9c567` synthetic inventory and incomplete lifecycle/platform/presentation proof; D `ce6fac13`/`ffc3ac6c` generic topology/incomplete proof. D active, A queued; B dependency-parked until accepted env successor and real assembly zones. C `ca41e6a2`, E `6dc88fca` preserved. Binding assembly remains A/B/C `128eef8a`→`23f13459`→`5cad5aab`→`248b60ec`. |
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | IN_PROGRESS — SQUAD ACTIVE | craps06_1/2; frozen env06_6 successor; owner-frozen game ritual contract | depth06_1 | Squad CRAPS06_3 — `/root/env06_7_pkg_c`, `codex/craps06_3-impl` | 2026-08-27 | — | Resumed from preserved UNREVIEWED product head `1d5dd3d5`. Squad is bound to row-local implementation/proof, frozen contract `a2760d81`, assembly manifests for shared files, and 30-minute anti-loss checkpoints. |
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN_PROGRESS — WIP PARKED FOR GAME RUNTIME | crew06_2/5/6/9; frozen env06_6 successor; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `codex/crew06_10-impl` | 2026-08-27 | — | Clean named branch preserved at immutable UNREVIEWED head `a0090874`, no stash or uncommitted tracked work. Slot rotated immediately to game06_1 after contract acceptance; crew/world models remain exclusively with the parallel lane. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS — PRODUCT SQUAD ACTIVE | accepted frozen contract `a2760d81`; landing held on red main | game06_2..7 | Squad GAME06_1 — `/root/landing_coordinator`, `codex/game06_1-impl` | 2026-08-27 | — | Integrator ACCEPT exact `a2760d816c781e711ff0923c296f97b786662453`: five contract-only files, validation PASS 4.762s, 72 negative fixtures, five neutrality targets, no product/runtime delta. Product implementation starts exactly from that head; contract files and their P3 whitespace are frozen. This squad is the recorded Family 1 shared-runtime/master-probe writer. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| world06_1 | `world06_1_crew_sequence_adapter_prompt.md` | BLOCKED — SECOND REJECTION / OWNER DECISION | env06_6 is Contract-red; owner ruling on persisted authority | world06_2..6 | parallel former-PM lane; dedicated Integrator | 2026-08-27 | — | Integrator rejected exact `ef55807d` P1: unsealed persisted `owner_outcome_results` can bypass consequence application/recovery after a transplanted or conflicting restore. Owner must authorize a closed causally sealed checkpoint plus hostile save/load negatives, or explicitly accept the authority exception. No third ordinary review round. |

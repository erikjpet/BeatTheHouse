...
| fix06_3 | `../todone/scratch_ticket_art_alignment_rca_and_fix_prompt.md` | DONE | — (analysed 2026-08-11, deferred from 0.5 to 0.6) | game06_5 inherits a clean surface | Codex | 2026-09-02 | main `996a98b6` | Owner chose a denser Crossword redesign. Seven-ticket alignment is complete on trunk; Crossword has one connected seven-word/22-cell grid with eight intersections, active stock, v10→v11 migration, regenerated overlays, GPU three-state review, and green all-140 focused contracts. |
...
| fix06_9 | `../todone/fix06_9_coin_pusher_web_performance_evidence_prompt.md` | DONE | landed evidence path | fix06_13 formal closeout | Codex | 2026-08-26 | 2026-09-01 | Maintained exact-300 shipped-Web plan, identity, action/draw/liveness and conservation evidence accepted. The harness row is complete; its red product result remains routed to active `fix06_13`. |
| fix06_13 | `fix06_13_coin_pusher_shipped_web_performance_prompt.md` | IN_PROGRESS | accepted fix06_9 evidence remediation | fix06_9, pusherv3_11 closure | recovery landing; Codex closeout | 2026-08-27 | — | Product remediation and exact-tree functional/parity gates pass, but locked shipped-Web performance remains red at `2d00206b`: ready 20.193s; skill-release 25.000ms; DROP 25.485ms; idle 16.667ms; skill-stop draw 8.610ms. Budgets remain unchanged. |
...
| pusherv3_11 | `pusherv3_11_pusher_program_closure_audit_prompt.md` | IN_PROGRESS | pusherv3_10, fix06_8, fix06_13 | pusher closure | prior review pool; Codex closeout | 2026-08-27 | — | Contract, goals, rulings, 600k EV, determinism/parity, lifecycle, visual and native gates pass. Formal closure waits only on the still-red `fix06_13` locked shipped-Web performance gate. Report: `docs/plans/coin_pusher_v3_program_closure_audit.md`. |

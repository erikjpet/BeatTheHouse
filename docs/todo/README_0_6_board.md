...
| game06_2 | `game06_2_blackjack_depth_prompt.md` | IN_PROGRESS — FRESH CONTRACT-ONLY CONSUMER AUDIT | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | game06_7 | Squad BLACKJACK; `codex/game06_2-contract-only` | 2026-08-27 | — | Old blocked `2def171d` remains preserved on rejected-runtime ancestry. Fresh branch bases directly on frozen contract; consumer-audit WIP `7e284ce9` committed before any Blackjack product edit. Rejected game06_1 runtimes and shared edits remain forbidden. |

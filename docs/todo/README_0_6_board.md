...
| world06_5 | `world06_5_plays_and_sweep_encounters_prompt.md` | IN_PROGRESS — THREE INDEPENDENT MODEL/DATA PACKAGES / WIP PRESERVED | world06_1/game06_1 for sequence and table integration, review and landing | — | Codex/lane:world06_5; `codex/world06_5` | 2026-08-27 | — | Claimed at `5dabfc0f` on clean main. First WIP `466ef943` committed 23:00:36 CDT, authored plays semantics + unique proof only, well before deadline. Police Sweep and crew-play model owners remain active in disjoint files. world06_1/game06_1 table/adapter/host authority excluded; proposal-only without existing root. No governing play value changed; Chip Dump remains model A 40+6 `cash_to_chips`. |

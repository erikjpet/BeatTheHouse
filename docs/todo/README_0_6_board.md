...
| game06_7 | `game06_7_showdown_duel_depth_prompt.md` | CLAIMING — CONTRACT-ONLY / INTEGRATION HELD | frozen contract `a2760d81`; accepted game06_1/game06_2 successors for integration | depth parity | Squad SHOWDOWN-DUEL; `codex/game06_7-contract-only` | 2026-08-27 | — | Freed Package B squad rotates here rather than idle. Dedicated branch/worktree bases directly on frozen contract and owns row-local duel staging, controls, state and proof while preserving the exact outcome ladder. Rejected runtimes and env/crew/world/shared assembly/board edits forbidden. First UNREVIEWED WIP due within 30 minutes. |
...
| world06_4 | `world06_4_backroom_jobs_recruitment_prompt.md` | RE-REVIEW QUEUED — FIRST-REJECTION SUCCESSOR | world06_1 for authoritative adapter integration and landing | — | Codex/lane:world06_4; dedicated Integrator | 2026-08-27 | — | Original `4863b1cc` preserved; clean successor `4a5be2b1` with recruitment `db3928fc`, hostile proof `6d84891d`, job head. Warm and fresh-copy import/check suites all GREEN; diff/status clean. Jobs report `host_commitment_not_verifiable_in_model`, recruitment `adapter_host_root_unavailable`; both are non-mutating proposals/fail closed. Caller commitments/expiry, forged state/chains/env/ledger/job evidence and empty ids reject; 13 job/seven recruit definitions/verbs locked; economy/tuning/values unchanged and no authority invented. Exact re-review queued. |
| world06_5 | `world06_5_plays_and_sweep_encounters_prompt.md` | IN_PROGRESS — THREE INDEPENDENT MODEL/DATA PACKAGES | world06_1/game06_1 for sequence and table integration, review and landing | — | Codex/lane:world06_5; `codex/world06_5` | 2026-08-27 | — | Claimed at lane commit `5dabfc0f` on clean main `a62f4884`. Three disjoint owners: Police Sweep model/proof, crew-play model/proof, and locked-value plays semantics/proof. world06_1/game06_1 table/adapter/host authority excluded; proposal-only if no existing root. Chip Dump stays model A with 40+6 `cash_to_chips`. First UNREVIEWED WIP due before 23:23 CDT. |

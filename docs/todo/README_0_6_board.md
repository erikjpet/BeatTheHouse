...
| game06_4 | `game06_4_machine_games_depth_prompt.md` | IN_PROGRESS — FIRST PRODUCT REJECTION REMEDIATION | landed frozen contract; accepted game06_1 product successor for integration | depth parity | Squad MACHINE-GAMES successor; Second Integrator | 2026-08-27 | — | Exact `259d6352` preserved after FIRST rejection before expensive gates. P1s: no real cash↔credit buy-in/cash-out or host-rooted hand-pay/lockup boundary; Video Poker equivalents are declarative with empty live bindings; declared actor/object ids do not govern live projection/render operations; focused proof is static and omits lifecycle, hostile claims, save, parity, allocation/liveness and visual/accessibility evidence. Row-local successor assigned; math/paytables/RTP/detection/heat remain locked. |

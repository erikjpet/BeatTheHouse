...
| fix06_10 | `fix06_10_coin_pusher_ev_evidence_runner_oom_prompt.md` | PARKED | accepted runner heads `861d2d40` + `74505132`; integration `ab584b0b` | `fix06_12` owner decision | PM:Codex/sub:ev_rca_remediation | 2026-08-26 | — | Validation/import/native smoke passed. The one exact run stopped safely on QF00 at 530 accepted + 4,096 consecutive ceiling refusals, active 600/tray 0/gutter 80, direct-worker peak 575,750,144 bytes; 23 shards were not started and no rerun occurred. This is persistent-machine liveness evidence, not an EV-band verdict. Only the owner may authorize a behavior-changing remedy through `fix06_12`; PM will not choose. |

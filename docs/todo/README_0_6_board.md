...
| audio06_1 | `audio06_1_surface_sfx_pass_prompt.md` | IN_PROGRESS | Families 1 and 2 rituals landed | — | PM:Codex/root | 2026-09-03 | — | Recovered the landed surface cue route and generalized the Coin Pusher manifest pattern across 13 profiles; focused deterministic/native-Web/budget audit is green while final integrated gates wait on Family 1/2 closeout merges. Music stays external. |

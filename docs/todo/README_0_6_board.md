...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fix06_31 | `fix06_31_environment_object_placement_grounding_prompt.md` | IN_PROGRESS | fix06_27 (DONE) | believable rooms; post-playtest polish | `/root` | 2026-09-10 | — | Owner direction 2026-09-10: people float in mid-air. PM static scan on `c570f2ce`: 132/302 scenario actor placements (44%) put feet above the floor line before collision displacement; zone-center resolution, board-wide collision fallback, wall-heavy base fallback grid, content-blind event slots and universal floor shadows are the mechanisms. Row = full audit (every room/scenario/phase/seed), per-room surface maps, class-aware placement engine, re-authoring pass, permanent grounding gates. |

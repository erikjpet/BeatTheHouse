...
| fix06_17 | `fix06_17_scratch_resolve_tail_timing_prompt.md` | TODO | retained `fix06_13` current-main native performance result | — | `/root/fix06_17_scratch_timing_route` | 2026-08-27 | — | ROUTED as a nonblocking timing defect. Exact `cce1c8df` actual_1 had one failure: Scratch resolve max `12.046/6.000 ms`; avg/p95 were green at `2.34789583333333/3.734 ms`. Report SHA-256 `4195D724...6090EA`. Historical evidence includes a max-only `2.66772916666667/4.901/12.652 ms` red and a broadly slow `5.565/11.716/12.621 ms` run; multiple green five-run series still support measurement/timing variance rather than a reproduced product regression. Every red remains preserved. No rerun, cap/test/product change or waiver occurred; `fix06_13` Coin Pusher scope was entirely green. |

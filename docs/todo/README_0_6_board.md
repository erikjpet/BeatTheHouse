...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| env06_6 | `env06_6_dynamic_scenario_runtime_prompt.md` | IN_PROGRESS — INTEGRATOR REOPENED | env06_1/2/3/5 (DONE) | env06_7, craps06_3, crew06_10, world06_1 landing | PM:Codex/sub:runtime-owner; dedicated Integrator | 2026-08-25 | — | Frozen source `855a2961` passed independent implementation/security review but the dedicated Integrator reopened it after exact-head Full red with 139 failures; `foundation_all` was timing-red at 295.473s > locked 230.652s. Integrator queue position 1; no director-side verdict/gate/main action. |
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS | frozen env06_6 `855a2961` | depth06_1 | Squads A-E + assembly: `codex/env06_7-pkg-a`..`-e`, `codex/env06_7-assembly`; assembly active | 2026-08-27 | — | Integrator handoffs: A `599e7f56`, B conditional `b1c9c567`, C `ca41e6a2` (35 ids). Preserved UNREVIEWED WIP: D `d9ce90e1` (12-id inventory), E `6dc88fca` (8 definitions + adapter request). Assembly is integrating exact net payloads/shared seams; D/E resume after assembly checkpoint. |

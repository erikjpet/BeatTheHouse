...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| env06_6 | `env06_6_dynamic_scenario_runtime_prompt.md` | ACCEPTED — PRIMARY INTEGRATOR LANDING NOW | env06_1/2/3/5 (DONE); Smoke-green main | env06_6b | PM:Codex/sub:runtime-owner; dedicated Integrator | 2026-08-25 | — | Piece 1 accepted exact `855a2961`, priority ahead of env06_7. Main is green at tree-identical quiesce marker `a04fa18b`; Primary Integrator is draining this oldest accepted item first under exclusive-main serialization. |

...
| env06_6b | `env06_6_dynamic_scenario_runtime_prompt.md` (remaining-runtime follow-on) | INTEGRATOR REVIEW/GATE — REQUIRED PRODUCT CLOSURE | green main; exact piece-1 payload | env06_7, craps06_3, crew06_10, world06_1 landing | parallel former-PM runtime lane; dedicated Integrator | 2026-08-27 | — | Exact frozen commits `757350a9..b7da64ae` contain the required closure for the genuine piece-1 gate red: lifecycle transaction atomicity, sealed-catalog alias resolution, and the retained functional failure classes. Primary Integrator is reviewing/gating now and will rebuild both payloads on the next serialized main head. No hardening or unrelated improvements. |
...
| game06_2 | `game06_2_blackjack_depth_prompt.md` | PRODUCT REVIEW QUEUED — FROZEN CONTRACT-ONLY HEAD | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | game06_7 | Squad BLACKJACK; `codex/game06_2-contract-only`; second Integrator | 2026-08-27 | — | Exact clean `e699d0bc` is frozen for independent review/gates; rejected game06_1 runtime is absent. Row-local depth proof covers five phases, accounting/reasons, save-boundary declaration, invalid gesture no-charge, tactile equivalence and 10-seed isolation. No acceptance claim before Integrator verdict. |
...
| game06_6 | `game06_6_bar_dice_depth_prompt.md` | CLEAN PARK — CONTRACT-ONLY / INTEGRATION HELD | frozen contract `a2760d81`; owner-resolved craps06_3 and accepted game06_1 successor for integration | depth parity | Squad BAR-DICE; `codex/game06_6-contract-only` | 2026-08-27 | — | Exact clean UNREVIEWED `348ecd55`, based on frozen `a2760d81`. Canonical contract PASS (72 negatives/5 neutrality); focused PASS for 7 phases/10 seeds, conservation, interruption, exactly-once/conflict/save-load, hidden-state and liveness; 15 inspected native captures. No shipped game/shared/env/crew/world/board edit. Intentionally not accepted-ready until craps06_3 and game06_1 are resolved and Integrator replays native/Web/full gates. |

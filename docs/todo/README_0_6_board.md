...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | PARTIAL PRODUCT ACCEPTED / REPLAY DOCS FIRST REJECTION | crew06_2/5/6/9; env06_6b for landing; accepted game ritual runtime successor | depth06_1 | former env/world lane; Primary Integrator | 2026-08-27 | — | Primary ACCEPTED exact partial `33999772`/tree `f9574c47`; second product review consumed. Replay manifest `8f954f69` was docs-rejected only because it falsely classified accepted/landed frozen contract `a2760d81`/merge `6d875539` as rejected and mandated replacement. Narrow successor must preserve its three bindings while separately holding rejected runtime product `932287ba` and missing accepted runtime authority. All memory/tell/interrupt/env/visual/Web/accessibility/performance/full gates remain blocked; product acceptance is unaffected. |

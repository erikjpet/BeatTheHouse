...
| world06_2 | `world06_2_streets_sequences_prompt.md` | IN_PROGRESS — BOUNDED MODEL REMEDIATION | world06_1 for receipt bridge/review/landing; Director-authorized independent model work may proceed | world06_6 | Codex/lane:world06_2 | 2026-08-27 | — | Product WIP `d045fb3b`; clean proof-only WIP `2b56a8ee` adds `world06_2_delivery_depth_contract.gd`. Focused behavior is red only on idempotent/out-of-order handoff, stash/found, and pursuit stash/retrieve/ditch transitions; generic cargo/hold/failure/persistence/determinism paths are silent/green. Core owner is limited to those exact failures, with economy/RNG/tuning unchanged and no receipt-bridge workaround. Receipt integration/review/landing remain held on world06_1 authority. |

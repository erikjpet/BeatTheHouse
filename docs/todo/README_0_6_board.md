...
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS | frozen env06_6 `855a2961` | depth06_1 | Squads A-E + assembly: `codex/env06_7-pkg-a`..`-e`, `codex/env06_7-assembly`; A active | 2026-08-27 | — | Five archetype packages cover all 55 ids exactly once; assembly exclusively owns shared catalog/index/pixel canvas/cross-seam fixtures. Package A UNREVIEWED product head `198eab1c` covers its 12 ids; B-E/assembly rotate into hard concurrency slots under the anti-loss rule. |
...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN_PROGRESS | crew06_2/5/6/9; frozen env06_6 `855a2961`; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `codex/crew06_10-impl` | 2026-08-27 | — | Product implementation active in `C:\bth-crew06_10`; no crew/world model ownership transfers. Ordered betting/reentry/tells/staging/five L3 nights are the owned scope. |

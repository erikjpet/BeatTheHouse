...
| art06_1 | `art06_1_punchline_layers_prompt.md` | IN_PROGRESS | env06_4 (DONE) | — | Codex/art06_1 | 2026-08-16 | | Punchline L1/L3 still reuse the underground raster (art debt logged by env06_4). Owns assets + manifest + `visual_context` only; L3 must leave crew06_6 furniture spots clear. |

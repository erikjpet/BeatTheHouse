...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| qa06_1 | `qa06_1_harness_production_fidelity_prompt.md` | IN_PROGRESS | playtest06_1 | reliable refinement evidence | `/root` | 2026-09-07 | — | Shared production-faithful travel/object helpers, incident-5 exact-target regression, all-travelling-harness audit, missing-finalization diagnostics, and historical record correction. |
| fix06_27 | `fix06_27_seed_dependent_room_finalization_prompt.md` | IN_PROGRESS | qa06_1 shared helpers | reliable room playability across seeds | `/root` | 2026-09-07 | — | Sweep and remove all walk-lane blockers, fix the inventory-night small-screen collision, add durable room-event collision avoidance, and require at least 8×55 finalizations. |

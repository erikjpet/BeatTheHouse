...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN REVIEW — PRODUCT FROZEN / DEPENDENCY-HELD | crew06_2/5/6/9; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | former env/world lane; Primary Integrator | 2026-08-27 | — | Product exact `678c3e2742fb0f1f93252b1ebd935a4248e85334`/tree `2c648e97` remains untouched. Immutable docs-only handoff exact `25114604`/tree `f6bcf45c` is queued for Primary review. Focused depth independently GREEN 5.100s; env/visual/native-Web/accessibility/performance/full-gate/integration evidence remains explicitly held. No product edit or local Godot run. |

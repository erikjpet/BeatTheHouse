...
| fix06_9 | `fix06_9_coin_pusher_web_performance_evidence_prompt.md` | IN_PROGRESS | pusherv3_11 finding | pusherv3_11 closure | Codex | 2026-08-26 | — | Add a maintained shipped-cap Web Coin Pusher frame/draw/idle-liveness evidence path. Exact native/Web parity is logic evidence, not a substitute for Web performance. |

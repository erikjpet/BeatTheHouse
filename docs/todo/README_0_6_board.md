...
| pusherv3_11 | `pusherv3_11_pusher_program_closure_audit_prompt.md` | IN_PROGRESS | pusherv3_10 | pusher closure | PM:Codex/sub:pusherv3-audit | 2026-08-26 | — | Genuine audit on exact landed V3/fix tree `59db0882`; entangled static source `554773c6` retained only as provenance. |

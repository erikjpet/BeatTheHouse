...
| game06_6 | `game06_6_bar_dice_depth_prompt.md` | CLAIMING — CONTRACT-ONLY / INTEGRATION HELD | frozen contract `a2760d81`; owner-resolved craps06_3 and accepted game06_1 successor for integration | depth parity | Squad BAR-DICE; `codex/game06_6-contract-only` | 2026-08-27 | — | Freed Showdown squad rotates here rather than idle. Dedicated frozen-contract branch owns row-local Bar Dice staging/controls/state/proof and treats shipped Craps dispersal/teaching/economy as read-only. Rejected runtimes and env/crew/world/shared assembly/board edits forbidden. First UNREVIEWED WIP due within 30 minutes. |
...
| world06_5 | `world06_5_plays_and_sweep_encounters_prompt.md` | IN_PROGRESS — PRODUCT FIRST REJECTION / DEDICATED PRIVACY REMEDIATION | world06_1/game06_1 for host mounting, composition and landing | — | Codex/lane:world06_5; `codex/world06_5-remediation`; dedicated Integrator | 2026-08-27 | — | Exact `07e98f16` frozen; dedicated remediation branch/worktree active. Owner touches only Sweep model + existing proof to remove caller-authored intel disclosure, consume an existing host root if representable or omit exact track/timing, and add hostile capability plus paired-observer proof. No self-hash/proposal capability or value/RNG change. Successor WIP due before 23:44 CDT. |

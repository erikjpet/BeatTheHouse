...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fix06_7 | `fix06_7_coin_pusher_v3_intro_copy_prompt.md` | IN_PROGRESS | V3 machine contract landed | accurate Coin Pusher player-facing copy | `/root/program_row_inventory` | 2026-08-26 | - | Copy-only correction for three stale V2 shelf references; implementation branch `codex/fix06_7-stale-pusher-copy` from exact main `a48f0d38`. Engine gates and independent visual review follow after EV workers release the engine. |

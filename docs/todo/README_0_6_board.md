...
| game06_7 | `game06_7_showdown_duel_depth_prompt.md` | IN_PROGRESS — CONTRACT-ONLY WIP PRESERVED | frozen contract `a2760d81`; accepted game06_1/game06_2 successors for integration | depth parity | Squad SHOWDOWN-DUEL; `codex/game06_7-contract-only` | 2026-08-27 | — | Clean WIP `0f8d6466` bases directly on frozen contract and records the exact data-backed ladder (`>=12`, `>=-60/<12`, `<-60`, early stack-zero), all shipped gates/routes/stakes/edge/cheat math read-only, nine receipt-bound staging phases, public-only Rourke/room/crew projection and forbidden hidden Turn inputs. No shared/runtime/Blackjack/env/crew/world/board edits. Row-local contract/projection/proof continues; integration held on accepted game06_1/game06_2 successors. |
...
| world06_5 | `world06_5_plays_and_sweep_encounters_prompt.md` | IN_PROGRESS — PRODUCT FIRST REJECTION / PRIVACY REMEDIATION | world06_1/game06_1 for host mounting, composition and landing | — | Codex/lane:world06_5; dedicated Integrator | 2026-08-27 | — | Exact `07e98f16` clean/frozen after first rejection. P1: caller-authored `sweep_intel=true` reveals real hidden current/heading/next action through a non-mutating proposal; substring-only proof misses capability-dependent disclosure. One qualified owner returns to consume an existing host-rooted capability if representable, otherwise omit exact track/timing and report the gap. Hostile boolean/substituted/recomputed negatives and paired observer audit required. No self-hash/proposal capability; plays, values, Chip Dump, sweep rungs, proposal-only mutation and RNG unchanged. |
| world06_6 | `world06_6_heist_and_turn_staging_prompt.md` | IN_PROGRESS — TWO PACKAGES STAFFED / MODEL OWNER ROTATING | world06_1/world06_2/crew06_10 for adapter, hot-exit and poker-tell integration, review and landing | world06_7 | Codex/lane:world06_6; `codex/world06_6` | 2026-08-27 | — | Based on clean main. Confrontation/privacy and locked-value semantics/forbidden-surface owners remain staffed. Qualified model owner must preserve a named anti-loss WIP, then return to world06_5 privacy remediation. Every crew06_8 failure remains binding; adapter/chase/poker/host authority excluded and proposals only where roots are absent. |

...
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | CORE RE-REVIEW QUEUED / ENV PACKAGE FIRST-REJECTED | craps06_1/2; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | Squad CRAPS06_3 + `codex/craps06_3-env-integration`; dedicated Integrator | 2026-08-27 | — | Core remediation `e8cc589e`/handoff `8ad3dd11` remains independently under review. Env exact `37353057` is clean/preserved after first rejection: unkeyed self-hash is treated as producer authentication; caller selects unsealed profile; `apply_response` accepts arbitrary registry-valid operations/full inventory; context/table ownership is unchecked. Exclusive env lane is remediating sealed result/transaction/receipt/boundary producer authority, package/table/context-bound profile selection, immutable response fingerprint and target/operation limits, plus hostile recomputation/cross-profile/operation/context-table negatives. Frozen env pieces untouched; assembly remains implementation-owner work. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS — FIRST-REJECTION REMEDIATION WIP GREEN | accepted frozen contract `a2760d81`; red main blocks landing only | game06_2..7 | Squad GAME06_1; dedicated Integrator | 2026-08-27 | — | Rejected `44fefe5f` preserved; checkpoints `c5e5d4d5` and `3e6fab15` are durable UNREVIEWED with focused suite PASS. Complete RitualCommand/authenticated-origin/fingerprint, closed result/rejection/error, per-handler allowlists, hostile restore/migration, plus exact closed fingerprinted GameFact, OperationResult, ReceiptRecord and RequestCacheRecord persistence/binding proofs are implemented. Contract untouched; exact gates continue before handoff. |
...
| game06_3 | `game06_3_baccarat_roulette_depth_prompt.md` | IN_PROGRESS — CONTRACT-ONLY SQUAD RESUMED | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad BACCARAT-ROULETTE; `codex/game06_3-impl` | 2026-08-27 | — | Resumed from clean UNREVIEWED `001f3c13`, based directly on frozen contract `a2760d81`. Row-local baccarat/roulette work only; rejected runtime `44fefe5f` remains forbidden until an accepted successor exists. Next WIP due within 30 minutes. |
...
| world06_2 | `world06_2_streets_sequences_prompt.md` | IN_PROGRESS — PRODUCT FIRST REJECTION / REMEDIATION ACTIVE | world06_1 for receipt bridge/integration/landing | world06_6 | Codex/lane:world06_2; dedicated Integrator | 2026-08-27 | — | Exact rejected `b4b2f9f8` clean/preserved. P1: handoff lacks current-position/carried possession and self-arrives; ditch permits remote relocation; found ignores exact stash place; move/duck/wait accept caller-authored teleport/cover without sealed source-route authority. P2: restored receipts are open and can suppress actions without envelope comparison. Ordinary remediation is bounded to physical location/possession/route/cover authority plus hostile remote/stash/place/teleport/cover/forged-receipt/malformed-restore negatives. Economy/RNG/tuning and blocked receipt bridge remain unchanged. |

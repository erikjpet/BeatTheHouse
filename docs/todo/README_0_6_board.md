...
| game06_3 | `game06_3_baccarat_roulette_depth_prompt.md` | PARKING — SLOT RETURNED TO CRAPS FIRST REJECTION | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad BACCARAT-ROULETTE | 2026-08-27 | — | Squad ordered to commit a named clean UNREVIEWED park, then return to craps06_3 remediation because finished/rejected intake jumps the queue. Rejected runtime `44fefe5f` remains forbidden. |

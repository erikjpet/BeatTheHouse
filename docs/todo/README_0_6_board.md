...
| fix06_32 | `../todone/fix06_32_unreviewed_game_rework_verification_prompt.md` | IN_PROGRESS | unreviewed 2026-09-09/10 game work | regression-protected game reworks | `/root` | 2026-09-11 | — | Retrospective independent verification: all 40 Craps wagers are derived/documented and million-roll measured with no payout changes; eight Audit/Full gates and hostile fixtures protect Craps, Hold'em, slot and Blackjack; production-host Hold'em and save custody are green. Final project/Audit gates pending. Report: `../plans/fix06_32_unreviewed_game_rework_verification_report.md`. |

...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS — CONTRACT FROZEN | owner directive: ship current contract; implementation exposes real gaps | game06_2..7 | Contract Authors A/B complete; product squad assignment pending slot | 2026-08-27 | — | Owner froze the contract after rejected heads `89bdafe9`, `6a47d19b`, and `a2760d81`; no further contract review/revision is authorized. Consumers implement against the frozen vocabulary and escalate real implementation gaps after two row rejections, never a third round. |

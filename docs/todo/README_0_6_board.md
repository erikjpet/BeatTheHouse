...
| game06_8 | `game06_8_games_depth_release_gate_prompt.md` | IN_PROGRESS | game06_2..7, depth06_1 | Family 1 closure | `/root/game_closeout` | 2026-09-03 | — | Closeout audit claimed from landed `main` at `914e5ac8`; game06_1/game06_2 acceptance reconciliation precedes the exact-tree gate. |
...
| integ06_1 | `integ06_1_composition_migration_soak_prompt.md` | IN_PROGRESS | Families 1 and 2 merged | playtest06_2 | `/root/world_closeout` composition/soak; `/root/integ06_1_fixtures` migration | 2026-09-03 | — | Split closeout is active from exact integrated main: this lane owns maximal shared-node composition plus terminal/determinism/native-Web/stability soak evidence; the separate migration lane owns genuine historical fixtures and the migration matrix. Overall row remains open until both combine and final gates pass. |

...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | ACCEPTED-READY — INTEGRATOR INTAKE | accepted frozen contract `a2760d81`; red main blocks landing only | game06_2..7 | Squad GAME06_1; dedicated Integrator | 2026-08-27 | — | Immutable product `44fefe5f`, clean; frozen contract untouched. Vocabulary PASS 72 negatives/7 neutrality, focused ritual including 10-seed parity PASS, validation 51.1s and load 26.2s PASS, direct registered game-module and surface contracts PASS with zero failures. Proof manifest discloses monolithic `foundation_games` exceeded the 304s outer limit without a report; relevant registered checks passed directly. |

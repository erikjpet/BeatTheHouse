...
| perf06_1 | `perf06_1_performance_platform_pass_prompt.md` | PRESTAGED — QUIESCED BASELINE / DEPENDENCY-HELD | Families 1 and 2 merged | playtest06_2 | quiesce evidence `a04fa18b`; prestage `567222db` | 2026-08-27 | — | Qualifying baseline 47.767s, 73 observations/8 seeds, zero failures, full 300-body sequence. Docs-only UNREVIEWED `567222db` defines exact hardware/build/quiescence/seed/warmup/sample fields and native/Web/low-end surface/runtime/composition/full-run/liveness/allocation matrix, identifying missing 0.5 comparators. No measurement/budget/harness/product change. Rerun only after five landings and pre-playtest on marker-proven idle host. |

...
| world06_5 | `world06_5_plays_and_sweep_encounters_prompt.md` | IN_PROGRESS — INDEPENDENT MODEL/DATA PACKAGE | world06_1/game06_1 for sequence and table integration, review and landing | — | Codex/lane:world06_5 | 2026-08-27 | — | Build only crew-play and Police Sweep model/data projections and focused pure-model proofs. Five plays remain table-presence proposals; sweep encounters remain model-authored street moments. Chip Dump funding stays shipped model A. No adapter/table/host authority invention. |

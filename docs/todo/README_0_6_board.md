...
| game06_2 | `game06_2_blackjack_depth_prompt.md` | RE-REVIEW QUEUED — FIRST-REJECTION SUCCESSOR | landed frozen contract; accepted game06_1 product successor for integration | game06_7 | Squad BLACKJACK successor; Second Integrator | 2026-08-27 | — | Rejected `e699d0bc` preserved; exact clean successor `4dbb83bf` closes charged `blackjack_place_bet` envelope/allowlist, live ids, frozen item/result fields and actual focused equivalent bindings with hostile no-charge proofs. Focused, 10-seed/RTP, terminal timing, heat-backoff and diff checks green; no math/RTP/timing/economy/shared-runtime edits. Independent exact-head re-review queued. |

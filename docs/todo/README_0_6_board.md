...
| game06_4 | `game06_4_machine_games_depth_prompt.md` | IN_PROGRESS — CONTRACT-ONLY WIP PRESERVED | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad MACHINE-GAMES; `codex/game06_4-impl` | 2026-08-27 | — | Clean UNREVIEWED `ff6f067b`, based directly on frozen contract `a2760d81`. One row-local 223-line Slot/Video Poker consumer contract maps code-reality authority, phases/actions/actors/objects/facts, tactile/accessibility, persistence, performance, conservation and proof; explicitly blocks rejected runtime. No shared/runtime/env/crew/world/board edit. |
...
| world06_3 | `world06_3_numbers_depth_prompt.md` | IN_PROGRESS — PURE-MODEL PROOF WIP PRESERVED | world06_1/world06_2 for route/adapter integration, review and landing; independent Numbers model package authorized | — | Codex/lane:world06_3; `codex/world06_3` | 2026-08-27 | — | Claimed at `0e161cc0` on clean main `a62f4884`; proof-only WIP `d1e0acd8` committed about 22:25 CDT. Covers five books, physical slip lifecycle, present/absent draw with no preview, authenticated idempotency/malformed restore, staged-fix invariants, save/determinism/no-heist; route/adapter/bridge excluded. Initial parse red corrected; later concurrent-job >60s hang was terminated without product attribution; check-only reports missing `RngStream` global despite exit 0. Model and non-economic authored-data owners remain active. |

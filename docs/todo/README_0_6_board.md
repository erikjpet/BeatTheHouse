...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS — CONTRACT FROZEN | owner directive: ship frozen contract `a2760d81`; implementation exposes real gaps | game06_2..7 | Contract Authors complete; product squad assignment pending slot | 2026-08-27 | — | Owner-overridden accepted-ready contract head is exactly `a2760d816c781e711ff0923c296f97b786662453`. No further contract review/revision is authorized. Later validator experiments remain preserved but are non-authoritative. Consumers implement against `a2760d81`; real gaps escalate after two row rejections, never a third round. |

...
7. **Standing hostile authority case for every remaining `world06_*` and
   ...
   behavior-identical output with no hidden-state difference.
...
| world06_6 | `world06_6_heist_and_turn_staging_prompt.md` | IN_PROGRESS — TWO PACKAGES STAFFED / HEIST SCAFFOLD PARKED | world06_1/world06_2/crew06_10 for adapter, hot-exit and poker-tell integration, review and landing | world06_7 | Codex/lane:world06_6; `codex/world06_6` | 2026-08-27 | — | Named anti-loss `0f5bdf88` committed 23:19:18 CDT with `crew_heist_model` + unique heist surface contract only; owner then stopped those files and moved to world06_5. Confrontation/privacy and locked-value authored-data packages remain independently staffed. Every crew06_8 failure remains binding; adapter/chase/poker/host authority excluded and proposals only where roots are absent. |
...
| fix06_21 | `fix06_21_main_smoke_hash_and_post_land_gate_prompt.md` | IN_PROGRESS — INLINE LANDING-BLOCKER REMEDIATION | exact main `a62f4884`; unchanged tests/budgets/baselines | Smoke-green main; drain landing queue oldest-first | correction landed `a62f4884`; inline squad `codex/fix06_21-main-smoke-health` | 2026-08-27 | — | Main is NOT green. Functional Smoke is green; latest exact-main idle series 2026-08-27 21:26:59–21:28:34 CDT is mandatory `foundation_performance_probe` red 4/1/4: Coin Pusher frame/draw/skill-stop/completeness, scratch resolve max, Baccarat p95. fix06_23 does not fix this. Per owner infra cap, remediation is inline in this row with every red retained and no test/budget/baseline/economy/tuning change. Queue is main-bound; second Integrator deferred. |

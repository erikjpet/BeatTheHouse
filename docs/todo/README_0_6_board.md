...
| game06_8 | `game06_8_games_depth_release_gate_prompt.md` | PRESTAGED — DOCS REVIEW QUEUED / DEPENDENCY-HELD | game06_2..7, depth06_1 | Family 1 closure | release-gate prestage author; Second Integrator | 2026-08-28 | — | Docs-only intake exact `bc42ade6`/tree `b78821ad` inventories exact game1–7/craps/depth/env/crew provenance and marks every verdict BLOCKED/UNVERIFIED. It binds all 11 shipped game ids plus duel/showdown, owner decisions, hostile paired observers, functional-only candidate/PostLand gates, quiesced performance cadence and native/Web/accessibility/visual/save/revisit/composition evidence. Independent docs review is queued; no product, gate or completion claim. |
...
| balance06_1-follow-on | prompt not yet materialized — ordered balance closure from accepted playtest06_2 accounting | BLOCKED — NOT MATERIALIZED / DEPENDENCY-HELD | Families 1 and 2 merged | playtest06_2 | unassigned; Director must materialize scope after dependencies | — | — | This is the reconciled 29th program row: full combined distributions, 600k pusher EV, findings and option-neutral proposals deferred from the landed partial `balance06_1`. It is not an infrastructure/fix row and cannot be claimed until its prompt, exact dependency tree and locked economy/RNG/tuning boundaries are materialized. |

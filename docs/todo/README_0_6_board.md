...
| game06_4 | `game06_4_machine_games_depth_prompt.md` | BLOCKED — FIRST-REJECTION SUCCESSOR / AUTHORITY DECISION | landed frozen contract; machine-credit/handpay authority | depth parity | frozen Squad MACHINE-GAMES | 2026-08-27 | — | Rejected `259d6352` preserved; clean successor `a1643b52` fixes live ids, executable VP equivalents, host-rooted Slot acknowledgement, hostile/live paired proof, lifecycle/save/conservation/liveness and removes false credit/threshold claims. Exact representability gap: owned Slot/VP state has no authoritative credit-conversion ledger and VP no handpay boundary, so conversion fails closed. Owner must choose shared single authority integration, explicit direct-bankroll/no-handpay requirement reduction, or a game-local ledger with schema/migration/conservation and accepted double-authority risk. No second review until boundary is chosen. |

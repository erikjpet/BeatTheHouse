...
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS | frozen env06_6 `855a2961` | depth06_1 | Squads A-E + assembly: `codex/env06_7-pkg-a`..`-e`, `codex/env06_7-assembly`; D active | 2026-08-27 | — | Integrator handoffs: A `599e7f56` (12 ids), B conditional `b1c9c567` (12 ids + assembly zone request), C `ca41e6a2` (11 ids). Package D active; E/assembly rotate next. Assembly exclusively owns shared catalog/index/pixel canvas/cross-seam fixtures. |

...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS | contract specification authored before implementation (program §3 override); implementation still consumes craps06_3 | game06_2..7 | /root/contract_author_game → /root/contract_author_world (contract only; reassigned after two rejections) | 2026-08-27 | — | Heads `89bdafe9` and `6a47d19b` were independently rejected; first-review P1s are fixed, and the director reassigned the three remaining receipt/action/fingerprint contract contradictions to Contract Author B. Product implementation remains stopped until exact contract acceptance. No craps special-case is permitted. |

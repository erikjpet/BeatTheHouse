...
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS — PACKAGE REMEDIATION RESUMED | accepted env06_6b plus ordered real catalog authority for landing | depth06_1 | Squads A-E + ordered assembly; all branches preserved | 2026-08-27 | — | D resumes from clean UNREVIEWED `06d4c818`; combined proof has no verdict. A `599e7f56`, B `b1c9c567`, C `ca41e6a2`, D original `ce6fac13` each have one rejection. A then C queue after D; B remains dependency/assembly-held. Binding A/B/C order unchanged. Red main blocks landing only, not branch work. |
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | IN_PROGRESS — SQUAD RESUMED | craps06_1/2; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | Squad CRAPS06_3 — `codex/craps06_3-impl` | 2026-08-27 | — | Resumes from clean UNREVIEWED `5efea7ce`; prior WIP `4ae3d339` and `1d5dd3d5` preserved. At next committed checkpoint the standing slot rotates immediately to crew06_10 under the finite concurrency cap. |
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN_PROGRESS — RESUME QUEUED AT CRAPS CHECKPOINT | crew06_2/5/6/9; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `codex/crew06_10-impl` | 2026-08-27 | — | Clean immutable UNREVIEWED `a0090874`, no stash or tracked WIP. Standing slot rotates from craps at its next committed checkpoint. Crew/world models remain exclusively with the parallel lane. Red main does not block branch implementation. |
...
| fix06_21 | `fix06_21_main_smoke_hash_and_post_land_gate_prompt.md` | IN_PROGRESS | exact red main `3f5e9907`; owner authorization | Smoke-green main; env06_6 piece-1 landing | Main-health correction squad; dedicated Integrator | 2026-08-27 | — | Prove the sole covered content delta is fix06_7 Quarter Falls copy, update exactly two stale hashes with all assertions retained, and make post-land verification fail closed on red exact main. Own small row; no product/runtime/budget change. |

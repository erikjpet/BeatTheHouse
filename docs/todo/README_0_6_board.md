...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| world06_1 | `world06_1_crew_sequence_adapter_prompt.md` | BLOCKED — SECOND REJECTION / OWNER MODEL DECISION | env06_6b; Smoke-green main; owner ruling on persisted authority | world06_2..6 | parallel former-PM lane; dedicated Integrator | 2026-08-27 | — | Exact `ef55807d` preserved. Decide: add the causal checkpoint inside DeliveryRunModel with explicit fail-closed legacy migration and retention of unresolved retry state, or accept adapter/untrusted checkpoint authority, or provide another binding. Required seal binds job_id, owner_token, neutral receipt id/cause, normalized resolution fingerprint/outcome, and closed public result fingerprint/value atomically with consequences. No third ordinary round. |

...
| world06_4 | `world06_4_backroom_jobs_recruitment_prompt.md` | IN_PROGRESS — INDEPENDENT MODEL/DATA PACKAGE | world06_1 for sequence/adapter integration, review and landing | — | Codex/lane:world06_4 | 2026-08-27 | — | Build only crew-model and authored-data surfaces for L3 occupancy, all 13 jobs and seven recruitment encounters. No EventModule/RunState/adapter/receipt authority while world06_1 is parked. `stake_horse` and `collection` remain model outcomes awaiting real sequences. |

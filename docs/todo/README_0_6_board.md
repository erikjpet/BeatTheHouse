...
| game06_3 | `game06_3_baccarat_roulette_depth_prompt.md` | FIRST REVIEW QUEUED — CONTRACT-ONLY IMPLEMENTATION | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad BACCARAT-ROULETTE; dedicated Integrator | 2026-08-27 | — | Clean handoff `2852387f`, with Roulette `c0d2b75e` and Baccarat `0d4b3ebb`, based directly on frozen contract; rejected runtime absent. Focused PASS both games; Roulette 157/157 hitboxes+payouts PASS; Baccarat 400 hands, zero non-content/game failures, B/P/T .468/.460/.072, resolve p95 1.007ms. Wrapper noise is 250 inherited frozen-base missing assets; diff-check PASS. Exact review queued. |
...
| game06_5 | `game06_5_counter_games_depth_prompt.md` | CLAIMING — CONTRACT-ONLY / REJECTED RUNTIME FORBIDDEN | accepted frozen contract `a2760d81`; accepted game06_1 product successor for integration | depth parity | Squad COUNTER-GAMES | 2026-08-27 | — | Former game06_3 squad rotates here rather than idle. Dedicated row-local branch/worktree based directly on frozen contract; rejected runtime and shared runtime/contract/env/crew/world/board edits forbidden. First UNREVIEWED WIP due within 30 minutes. |
...
| world06_3 | `world06_3_numbers_depth_prompt.md` | IN_PROGRESS — INDEPENDENT MODEL PACKAGE | world06_1/world06_2 for route/adapter integration, review and landing; independent Numbers model package authorized | — | Codex/lane:world06_3; `codex/world06_3` | 2026-08-27 | — | Claimed at `0e161cc0` on clean main `a62f4884`, deliberately excluding rejected world1/2 authority. Separately staffed model and pure-model proof packages own only Numbers physical slip/bookmaker/draw/fix state and closed action receipts. Route/adapter/bridge/receipt authority excluded. First UNREVIEWED WIP due 22:46 CDT. |

...
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN_PROGRESS — SQUAD ACTIVE | crew06_2/5/6/9; frozen env06_6 successor; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `/root/landing_coordinator`, `codex/crew06_10-impl` | 2026-08-27 | — | Resumed from preserved UNREVIEWED head `a0090874`. Squad remains row-local to `crew_draw_poker.gd` and proof; crew/world models stay exclusively with the parallel lane. Contract `a2760d81` is immutable. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | IN_PROGRESS — CONTRACT ACCEPTED / PRODUCT SLOT ROTATING | accepted frozen contract `a2760d81`; landing held on red main | game06_2..7 | Contract Authors complete; Family 1 product squad assigned next safe checkpoint | 2026-08-27 | — | Integrator ACCEPT exact `a2760d816c781e711ff0923c296f97b786662453`: five contract-only files, validation PASS 4.762s, 72 negative fixtures, five neutrality targets, no product/runtime delta. Four trailing-whitespace lines are P3 and will not trigger another round. Consumers and product squad start from this accepted frozen head without waiting for landing. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| world06_1 | `world06_1_crew_sequence_adapter_prompt.md` | IN_PROGRESS — INTEGRATOR QUEUED | frozen env06_6 head `855a2961`; rebase if rejected | world06_2..6 | parallel former-PM lane | 2026-08-27 | — | Other lane implemented/handed head `9e7e673b`; dedicated Integrator queue position 2 and dependency-blocked behind reopened env06_6. Exclusive crew/world/EventModule ownership remains with that lane. |

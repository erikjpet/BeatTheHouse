...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| env06_6 | `env06_6_dynamic_scenario_runtime_prompt.md` | IN_PROGRESS — FEATURE-FROZEN / INTEGRATOR GATING | env06_1/2/3/5 (DONE) | env06_7, craps06_3, crew06_10, world06_1 landing | PM:Codex/sub:runtime-owner; dedicated Integrator | 2026-08-25 | — | Owner feature freeze is binding after the second ready-then-changed cycle: only changes strictly required to turn a currently-red gate green may be committed. Hardening, sealing, and improvements defer to separately claimed rows after env06_6 lands. Integrator is gating successor `9d3cada4`; director owns no verdict/gate/main action. |
...
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | IN_PROGRESS — WIP PARKED | craps06_1/2; frozen env06_6 `855a2961`; owner-frozen game ritual contract | depth06_1 | Squad CRAPS06_3 — `codex/craps06_3-impl` | 2026-08-27 | — | UNREVIEWED product head `1d5dd3d5` in `craps.gd` implements tactile ritual/wager controls/actors/energy/public fact seam. Cheap diff check green; parse probe hung and made no gate claim. Slot rotated to start Crew; branch/worktree preserved. |
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | IN_PROGRESS — WIP PARKED | crew06_2/5/6/9; frozen env06_6 `855a2961`; owner-frozen game ritual contract | depth06_1 | Squad CREW06_10 — `codex/crew06_10-impl` | 2026-08-27 | — | UNREVIEWED product head `a0090874` adds fresh-session reentry/migration and ordered action-relative tell receipts in `crew_draw_poker.gd`; no crew/world model edits. Slot rotated to env packages; branch/worktree clean and preserved. |

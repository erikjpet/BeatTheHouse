...
7. **Standing hostile authority case for every remaining `world06_*` and
   ...
   world-side checklist exact `2c76a9ea` landed as `232ec7d6`; game-side exact
   `7e42c0b4` landed as `c00eca1b`. Both remain binding on all later reviews.
...
| env06_6b | `env06_6_dynamic_scenario_runtime_prompt.md` (remaining-runtime follow-on) | BLOCKED — SECOND REJECTION / THREE-AXIS OWNER DECISION | green main; exact piece-1 payload | env06_7, craps06_3, crew06_10, world06_1 landing | frozen former-PM runtime lane; dedicated Integrator | 2026-08-27 | — | Exact `e297ca8f`/tree `71a61ae0` frozen after SECOND rejection; no third ordinary cycle. P1s are caller-granted augment availability, aliased mutable TownState/NumbersModel rollback, and absent durable save semantic root. Combined docs-only packet exact `cde170b8` is independently ACCEPTED and presents independent V authority/R rollback/S save axes and all 27 combinations neutrally: sealed/de-authorized/exception, detached-atomic/graph-complete-in-place/exception, and closed-root/semantic-equivalence/compatibility-exception. It binds exact provenance, hostile/alias/16+3/55-legacy evidence and every downstream hold. No option selected, Smoke restart, product edit or workaround. |
| env06_7 | `env06_7_all_variations_sequence_rework_prompt.md` | IN_PROGRESS — C OWNER DECISION; ASSEMBLY CHECKPOINT READY; B/E PARKED | accepted env06_6b plus ordered real catalog authority for landing | depth06_1 | Squads A-E + ordered assembly; all branches preserved | 2026-08-27 | — | A/D handed off; C second-rejected; E `08ff8e8a`; B `0550d974`. Sole assembly `d78b9004` preserves A→B→C and shared authority. Package C option packet `6d0730d7`: A same-scope per-identity spatial/evidence closure + exceptional review; B split `env06_7c1` spatial authority / `env06_7c2` evidence with order/depth held; C explicit generic-task/assembly-only-evidence exception. No option selected; fixed ordering and sole assembly ownership remain binding. |
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | BLOCKED — CORE + ENV SECOND REJECTIONS / OWNER DECISION | craps06_1/2; env06_6b for landing; landed game ritual contract | depth06_1 | frozen core + env squads; dedicated Integrator | 2026-08-27 | — | Core `e8cc589e`/`8ad3dd11` and env `872d09a9` are frozen; no third ordinary cycles. Option-neutral docs packet `4f778efb` binds exact histories and offers: A same-scope exceptional closure; B split into `craps06_3a` Ritual Sequence Completion and `craps06_3b` Environment Authority and Assembly with downstream holds; C explicit requirement reductions/design exception. Dedicated implementation owns assembly; Integrator implementation is forbidden. No option selected. |
| crew06_10 | `crew06_10_backroom_poker_depth_rework_prompt.md` | PARTIAL PRODUCT ACCEPTED / DEPENDENCY-HELD | crew06_2/5/6/9; env06_6b for landing; accepted game ritual authority successor | depth06_1 | former env/world lane; Primary Integrator | 2026-08-27 | — | Primary independently ACCEPTED exact partial `33999772`/tree `f9574c47` within the Director-authorized boundary. Player fold continues legal ordered NPC-only settlement with hidden exclusion; raw interrupts are proposal-only/no-op; caller-mintable receipts cannot activate memory/tells; missing roots fail closed with named gaps; migration synthesizes no authority; hostile/profile/raise-fold/restore matrices bind the slice. This consumed the second review. Authentic game06_1/env memory/tell/interrupt roots and all env/visual/Web/accessibility/performance/full gates remain held; no row, gate, integration or landing acceptance. |
| depth06_1 | `depth06_1_games_and_scenarios_release_gate_prompt.md` | PRESTAGED — DOCS ACCEPTED / DEPENDENCY-HELD | env06_7, craps06_3, crew06_10 | depth-program closure | prestage author; Second Integrator | 2026-08-28 | — | Docs-only intake successor exact `5d44725b` independently ACCEPTED after correcting the first review's sole material 13→12 archetype contradiction. It accounts for all 55 IDs, deterministically defers unbiased two-per-archetype sampling, binds high-risk compositions/capture provenance, and honestly marks every closure verdict BLOCKED/UNVERIFIED. No captures, gates, product or landing claim. |
...
| fix06_9 | `fix06_9_coin_pusher_web_performance_evidence_prompt.md` | PRESTAGED — DOCS ACCEPTED / FIX06_13 RESULT HELD | pusherv3_11 finding; accepted+landed fix06_13 | fix06_13 | replay prestage author; Second Integrator | 2026-08-26 | — | Evidence `f6a06d5f` landed unchanged as `112cb02d`; first shipped-Web red `54e6398a` and fix06_13 locked red `c914546f` remain preserved. Docs-only replay intake exact `e8ce4558`/tree `6541d3cb` independently ACCEPTED as custody/gap documentation; it binds every recorded hash/measurement, exact future identities, all 18 closure criteria and the exactly-one locked fix06_13 result rule. Current `62d45c2e` functional red keeps every dependency-sensitive verdict BLOCKED/UNVERIFIED and the locked run NOT RUN. |
| fix06_13 | `fix06_13_coin_pusher_shipped_web_performance_prompt.md` | BLOCKED — SECOND REMEDIATION REJECTION / OWNER DECISION | accepted fix06_9 evidence remediation; fix06_14/16 DONE | fix06_9, pusherv3_11 closure | frozen Squad FIX06_13; Second Integrator | 2026-08-27 | — | Exact `0414cefc` passed second review and native build (418.7s; DLL `619FB31A…3ECAD`), validation/import/load 52.338/45.590/25.569s, but focused gate failed before assertions on two warning-as-error inferred-Variant diagnostics for new `weakref(...)` locals. This is the remediation's SECOND rejection: no third cycle. Owner must authorize A exactly two explicit `WeakRef` annotations plus exceptional review/qualification; B another bounded test-only proof rewrite retaining both-path ownership assertions; or C park/reshape. Locked Web remains NOT RUN/UNCONSUMED; no weakening or rerun. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| game06_1 | `game06_1_table_machine_ritual_runtime_prompt.md` | CONTRACT LANDED / PRODUCT SECOND REJECTION — OWNER DECISION | frozen contract landed; product authority decision | game06_2..7 | frozen Squad GAME06_1; dedicated Integrator | 2026-08-27 | — | Contract `a2760d81` landed as `6d875539`; validator/architecture green. Product `932287ba` frozen after SECOND rejection; no third ordinary cycle. Option-neutral packet `0f64e85b`: A sole-authority redesign + exceptional review; B preserve compliant closed primitives and open `game06_1b` Ritual Authority Consolidation while every consumer remains blocked; C explicit `GAME-RITUAL-AUTH-EXCEPTION-01` retaining alternate mutation/restore authority and accepting documented game2–7 risks. No option selected. |
| game06_2 | `game06_2_blackjack_depth_prompt.md` | BLOCKED — PRODUCT SECOND REJECTION / OWNER DECISION | landed frozen contract; accepted game06_1 product successor for integration | game06_7 | frozen Squad BLACKJACK; Second Integrator | 2026-08-27 | — | Exact `4dbb83bf` frozen after SECOND rejection; no third ordinary cycle. Live ids/records improved, but bare resolver/wager-cost and target-discarding production routing bypass ritual authority. Option-neutral packet `958fd02d`: A same-scope sole resolver/input authority + exceptional review; B preserved non-authoritative presentation/records plus `game06_2b` Blackjack Ritual Authority Integration with game7/8 held; C explicit bare-resolver/helper-routing exception. Consumer, money, save/revisit and parity consequences are enumerated; no option selected. |
| game06_3 | `game06_3_baccarat_roulette_depth_prompt.md` | BLOCKED — PRODUCT SECOND REJECTION / OWNER DECISION | landed frozen contract; accepted game06_1 product successor for integration | depth parity | frozen Squad BACCARAT-ROULETTE; dedicated Integrator | 2026-08-27 | — | Exact `4c10e3b8` frozen; no third ordinary cycle. Option-neutral packet `647736bc`: A same-scope Baccarat closure + exceptional review; B preserve corrected Roulette and open `game06_3b` Baccarat Ceremony Completion while Family1 remains blocked; C explicit four-part exception. Pre-window concealment, resumable pointer squeeze, hand-bound persistence and material actor/object/energy behavior remain mandatory under A/B and are waived only explicitly under C. |
| game06_4 | `game06_4_machine_games_depth_prompt.md` | BLOCKED — FIRST-REJECTION SUCCESSOR / TWO-AXIS OWNER DECISION | landed frozen contract; machine-credit/handpay authority | depth parity | frozen Squad MACHINE-GAMES | 2026-08-27 | — | Rejected `259d6352`; clean successor `a1643b52` fixes live ids/equivalents/acknowledgement/hostiles/lifecycle and removes false authority. Independently accepted docs packet exact `abf9e2bc` separates wagering authority W0 direct-bankroll/W1 shared-credit/W2 local-credit from handpay H0 none/H1 shared host-rooted/H2 local and states all nine combinations neutrally. W0+H1 explicitly preserves existing bankroll settlement while deriving host handpay qualification/ack from accepted results and owner policy, with no credit ledger or duplicate payout. No option selected or second product review before decision. |
| game06_5 | `game06_5_counter_games_depth_prompt.md` | BLOCKED — CLEAN PARK / OWNER ART DECISION | landed frozen contract; accepted game06_1 product successor for integration | depth parity | Squad COUNTER-GAMES; `codex/game06_5-impl` | 2026-08-27 | — | Clean partial WIP `8efd58bc`; no Pull Tabs, art, or tests. Option-neutral evidence packet `19bdc9f0` locks current mechanics/RTP/art hashes and six-ticket boundaries and states executable consequences without recommendation: A rebuild Crossword as printed grid with RTP/mechanics change; B repaint Crossword while preserving mechanics/RTP; C align the other six and hold Crossword, with an additional historical-save sub-policy required. No option selected. |
| game06_6 | `game06_6_bar_dice_depth_prompt.md` | CLEAN PARK — CONTRACT-ONLY / ACCEPTED REPLAY PRESTAGE | frozen contract landed; owner-resolved craps06_3 and accepted game06_1 product successor for integration | depth parity | Squad BAR-DICE; `codex/game06_6-contract-only` | 2026-08-27 | — | Exact clean product `348ecd55`. Canonical/focused proof and 15 native captures remain retained. First replay manifest `a9952ded` was docs-rejected; exact successor `308d810f` is independently docs-ACCEPTED and now binds the full hostile caller-authority/paired-observer matrix plus functional-only candidate/PostLand gates and quiesced performance cadence. This is prestage documentation only: no shipped game/shared/env/crew/world edit, product acceptance or landing claim. |
| game06_7 | `game06_7_showdown_duel_depth_prompt.md` | CLEAN PARK — CONTRACT-ONLY / INTEGRATION HELD | landed game contract; owner-resolved game06_2; accepted world/crew authority | depth parity | Squad SHOWDOWN-DUEL; `codex/game06_7-contract-only` | 2026-08-27 | — | Exact clean `25f16c4e`; validator/9-phase/10-seed/native-Web/capture evidence retained. Docs-only replay manifest `8c5e4839` fail-closes on the second-rejected game06_2 disposition, crew/world authority, ladder preservation, both endings, nine-phase save/revisit, hidden-Turn paired observers, caller-authority hostiles and native/Web/full gates. No product replay or acceptance claim until dependencies resolve. |
| game06_8 | `game06_8_games_depth_release_gate_prompt.md` | PRESTAGED — DOCS ACCEPTED / DEPENDENCY-HELD | game06_2..7, depth06_1 | Family 1 closure | release-gate prestage author; Second Integrator | 2026-08-28 | — | Docs-only intake exact `bc42ade6`/tree `b78821ad` independently ACCEPTED as custody/gap documentation. It verifies exact game1–7/craps/depth/env/crew provenance, all 12 holds, all 11 shipped game ids plus duel/showdown, hostile paired observers, functional-only candidate/PostLand gates, quiesced performance cadence and native/Web/accessibility/visual/save/revisit/composition evidence. Every verdict remains BLOCKED/UNVERIFIED; no product, gate or completion claim. |
...
| ID | Prompt | Status | Depends on | Unblocks | Agent | Started | Finished | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| world06_1 | `world06_1_crew_sequence_adapter_prompt.md` | BLOCKED — OPTION A RECEIPT-TIMING OWNER DECISION / CLEAN PARK | sealed DeliveryRunModel checkpoint; env06_6b/green main only for landing | world06_2..6 | parallel former-PM lane; dedicated Integrator | 2026-08-27 | — | Test-only `9d6ff952` remains frozen; mounted expiry/abandon receipt does not exist when atomic owner apply/checkpoint must occur. Option-neutral packet `d789a921`: A1 authorize non-persisting adapter prepare/preview before owner apply, preserving adapter receipt authority/model checkpoint authority; A2 name another single-authority pre-apply mechanism; A3 explicitly change ordering/receipt binding. Direct handoff rejection, v1 fail-closed/direct-applied distinction, atomic apply→ack/cleanup and world2/3 inheritance are bound. No option selected. |
| world06_2 | `world06_2_streets_sequences_prompt.md` | BLOCKED — PRODUCT SECOND REJECTION / COUPLED OWNER DECISION | world06_1 host-rooted authority for integration/landing | world06_6 | frozen Codex/lane:world06_2; dedicated Integrator | 2026-08-27 | — | Exact `e4f4194f` frozen after SECOND rejection; no third ordinary cycle. Possession/location improved, but route/cover/receipt seals remain recomputable and target optional. Option-neutral packet `6ff384f4`: A host-rooted route/cover/cargo/mandatory-target authority coupled to world1 + exceptional review; B proposal-only partial plus `world06_2b`, holding world6/7; C explicit `WORLD06_2-BARE-AUTHORITY-01`. Movement/cargo/receipt/save/double-fire consequences enumerated; no option selected. |
| world06_3 | `world06_3_numbers_depth_prompt.md` | BLOCKED — PRODUCT SECOND REJECTION / OWNER DECISION | world06_1/world06_2 for authoritative host commit/integration/landing | — | frozen Codex/lane:world06_3; dedicated Integrator | 2026-08-27 | — | Exact `e7aca347` frozen after SECOND rejection; no third ordinary cycle. Proposal-only behavior and terminal attendance improved; restore still accepts forged depth state when receipt keys are stripped. Option-neutral packet `94dc1731`: A bounded fail-closed restore closure + exceptional review; B non-persisted/non-authoritative partial plus `world06_3b`, holding world7; C explicit `WORLD06_3-RESTORE-COMPAT-01` stripped-record compatibility exception. Migration/privacy/economy consequences enumerated; no option selected. |
...
| world06_7 | `world06_7_crew_world_depth_release_gate_prompt.md` | PRESTAGED — DOCS ACCEPTED / DEPENDENCY-HELD | world06_2..6 | Family 2 closure | release-gate prestage author; Primary Integrator | 2026-08-28 | — | Docs-only intake exact `5f79be20`/tree `d55f2b5a` independently ACCEPTED as custody/gap documentation only. All referenced objects, commit/tree pairs and landed hostile blobs verify; world2/3 remain second-rejected, world4/5/6 remain proposal-only slices, and every authentic-root/integration/restore/receipt/hash/privacy/platform/performance/accessibility/visual verdict stays BLOCKED/UNVERIFIED. No product, gate, landing or row-acceptance claim. |
...
| balance06_1-follow-on | `balance06_1_follow_on_cross_system_economy_audit_prompt.md` | CONTRACT ACCEPTED / DEPENDENCY-HELD | Families 1 and 2 merged | playtest06_2 | Contract Author; Second Integrator | 2026-08-28 | — | This is the reconciled 29th program row. Docs-only prompt exact `b047e1a0`/tree `fd238ab3` independently ACCEPTED after removing row-local performance authority. It materializes 64 seeds × 8 playstyles, 200k accepted paid drops per machine/600k combined, findings and option-neutral proposals with locked economy/RNG/tuning. Qualification is functional-only; the row may only consume the next cadence-eligible Integrator checkpoint and must hand off as PENDING if absent. No product, gate, claim or release authority. |
...
| pusherv3_11 | `pusherv3_11_pusher_program_closure_audit_prompt.md` | PRESTAGED — DOCS ACCEPTED / DEPENDENCY-HELD | pusherv3_10; landed fix06_13 closure; fix06_8/fix06_24 decision | pusher closure | preserved audit branch; replay prestage author; Second Integrator | 2026-08-27 | — | Rejected claim `8541f643` and incomplete audit `554773c6` remain provenance only. Docs-only immutable replay prestage exact `f05d14de` independently ACCEPTED as custody/gap documentation; it fail-closes on accepted+landed fix06_13 and exactly one new locked landed-output result, all historical reds/timeouts, tooling-only fix06_8 plus unresolved fix06_24, and every EV/determinism/parity/conservation/lifecycle/performance/broad/visual/code-health/hostile-authority gate. No gate, rerun, product, physics or completion claim. |
...
| fix06_22 | `fix06_22_fail_closed_post_land_verification_prompt.md` | DONE — LANDED / FUNCTIONAL POSTLAND GREEN | green main | reliable DONE eligibility | accepted `557af45b`; merge `9ea919fe`; Second Integrator | 2026-08-27 | 2026-08-27 | No-ff merge `9ea919fe` parents `6d875539` + `557af45b`. Canonical DLL SHA256 `67B21FE1…E85F7F`; identity, validation 57.237s, import 19.209s, load 26.762s, native 3.766s, foundation 41.280s, UI 59.858s, Dave 7.347s and audio 5.055s PASS. An accidentally included non-quiesced performance stage is retained red/nonqualifying and cannot affect DONE under the owner cadence; performance runs only after five landings and pre-playtest on a marker-proven quiesced host. |
...
| fix06_24 | `fix06_24_coin_pusher_adjacent_coin_movement_defect_prompt.md` | BLOCKED — PRODUCT-PHYSICS DEFECT / OWNER DECISION | exact fix06_8 evidence `1f0595af` | pusherv3_11 | evidence squad; owner authorization required | 2026-08-27 | — | Corrected docs-only packet exact `a761f2c5` independently ACCEPTED: prompt absent from main `00ee744f`, present off-main at `a3865e4d`/blob `8011fa54`, and classification-only. Choice remains A authorize a separately bounded product-physics remediation, or B revise/cut Plan 9.4. No selection, diagnosis, rerun/search or physics/geometry/nozzle/transport/contact/tuning/neighboring-stock authority exists; pusherv3_11 remains held. |
...
| integ06_1 | `integ06_1_composition_migration_soak_prompt.md` | PRESTAGED — DEPENDENCY-HELD / FIXTURE GAP | Families 1 and 2 merged | playtest06_2 | future integration squad | 2026-08-27 | — | Docs-only partial UNREVIEWED `e3b915bd` inventories two genuine committed historical loadable fixtures (0.3.0/0.3.3), distinguishes goldens/generated validation output from real player saves, and maps known migration promises. No genuine 0.5 or mid-0.6 player-save fixture was found in the bounded scan; exhaustive provenance scan remains required after dependencies. No harness/product/test edit or gate claim. |
| perf06_1 | `perf06_1_performance_platform_pass_prompt.md` | PRESTAGED — TWO QUIESCED BASELINES / DEPENDENCY-HELD | Families 1 and 2 merged | playtest06_2 | markers `a04fa18b`, `00ee744f`; prestage `567222db` | 2026-08-27 | — | Fifth-landing checkpoint source `c00eca1b`, marker `00ee744f`, qualifying 2026-08-28 00:14:51–00:15:38 CDT: 46.663s, 73 observations/8 seeds, zero failures/stderr, 300-body sequence, CPU 3.923/4.467/10.839%, solver p95 3.793ms, scratch max 4.301ms, Baccarat p95 0.943ms. Docs-only `567222db` defines final native/Web/low-end/composition/liveness/allocation matrix. No budget/harness/product change; next run after five more landings or pre-playtest. |
| teach06_2 | `teach06_2_teaching_pass_two_prompt.md` | PRESTAGED — DEPENDENCY-HELD | depth06_1, game06_8, world06_7 | — | future teaching squad | 2026-08-27 | — | Docs-only immutable UNREVIEWED `19e24974` accounts for all 63 catalog ids exactly once: 62 currently correct, 1 stale (`tip06_coin_pusher` lacks live carriage-drag/hold-to-charge verbs), 0 redundant, 0 broken. Every dependency-sensitive classification is marked for post-land re-audit; no lesson/coach/runtime/test edit or acceptance claim. |
| playtest06_2 | `playtest06_2_playtest_gate_refresh_prompt.md` | PRESTAGED — DOCS ACCEPTED / DEPENDENCY-HELD | integ06_1, perf06_1 | owner playtest | future playtest squad; Second Integrator review | 2026-08-28 | — | Docs-only exact `bd790830` independently ACCEPTED as snapshot classification/intake only. It inventories 28 explicit rows plus the ordered, not-yet-materialized balance follow-on as the 29th; all seeds remain TBD/UNVERIFIED, board statuses are transcription rather than acceptance truth, and dependency/evidence gaps fail closed. No playtest, product, gate or completion claim. |

...
| game06_4 | `game06_4_machine_games_depth_prompt.md` | BLOCKED — FIRST-REJECTION SUCCESSOR / AUTHORITY DECISION | landed frozen contract; machine-credit/handpay authority | depth parity | frozen Squad MACHINE-GAMES | 2026-08-27 | — | Rejected `259d6352`; clean successor `a1643b52` fixes live ids/equivalents/acknowledgement/hostiles/lifecycle and removes false authority. Owned state has no credit-conversion ledger or VP handpay boundary. Option-neutral packet `a691d994`: A shared host-rooted authority integration; B explicit direct-bankroll/no-VP-handpay scope reduction; C game-local authorities with schema/migration/conservation and accepted double-authority risk. game1/game8/audio consequences enumerated; no option selected or second review before decision. |

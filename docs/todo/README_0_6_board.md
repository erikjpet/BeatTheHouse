...
| world06_6 | `world06_6_heist_and_turn_staging_prompt.md` | IN_PROGRESS — INDEPENDENT MODEL/DATA PACKAGE | world06_1/world06_2/crew06_10 for adapter, hot-exit and poker-tell integration, review and landing | world06_7 | Codex/lane:world06_6 | 2026-08-27 | — | Claimed at lane commit `0f874a53` after world06_5 entered review. Build only crew-heist/Turn model and authored-data projections with focused proofs. Both plans, both exits and confrontation remain non-authoritative proposals until dependencies land. Adapter, hot-exit delivery, poker-tell and host authority remain excluded; no hidden-state exposure or authority invention. |

...
| craps06_3 | `craps06_3_craps_depth_rework_prompt.md` | BLOCKED — CORE SECOND REJECTION / OWNER DECISION; ENV SUCCESSOR REVIEW HANDOFF | craps06_1/2; env06_6b for landing; owner-frozen game ritual contract | depth06_1 | frozen core squad + `codex/craps06_3-env-integration`; dedicated Integrator | 2026-08-27 | — | Core exact `e8cc589e`/handoff `8ad3dd11` frozen after SECOND rejection; no third ordinary cycle. Owner must choose same-scope completion with exceptional review, explicit row/contract split retaining tactile improvements while naming all open successor scope, or requirement reduction/cut. Env first-rejection successor `872d09a9` arrived clean at 22:20:01 CDT and is in exact-head review handoff; rejected `37353057` remains preserved. Core and env cycles remain independent. |

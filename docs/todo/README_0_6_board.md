...
| world06_7 | `world06_7_crew_world_depth_release_gate_prompt.md` | PRESTAGED — DOCS REVIEW QUEUED / DEPENDENCY-HELD | world06_2..6 | Family 2 closure | release-gate prestage author; Primary Integrator | 2026-08-28 | — | Docs-only intake exact `5f79be20` binds landed hostile checklist `232ec7d6`, exact world2–6 provenance, second-rejected world2/3 and proposal-only accepted world4/5/6 boundaries. Every authentic-root/integration/restore/receipt/exactly-once/composition/value-hash/paired-observer/native-Web/determinism/performance/accessibility/visual verdict remains BLOCKED/UNVERIFIED. Independent docs review is queued; no product, gate or completion claim. |

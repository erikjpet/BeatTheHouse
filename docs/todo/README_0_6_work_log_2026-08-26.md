...
* 2026-08-27 — LANDING BLOCKER: Integrator will not land any queued candidate onto Smoke-red current main `3f5e9907`; queue depth is seven and oldest accepted-ready age is about 75 minutes. Main-health triage is the active critical-path assignment. Last known green is `f9eaebbf`; the identical failure is proven by `ff2d4e14`, but the exact first bad commit inside that interval remains under causal isolation.

...
| --- | --- | --- | --- | --- |
| 1 | v04_worktree_baseline_and_gate_recovery_prompt.md | ready | any | Partition/commit current dirty tree, reconcile archived prompts, and establish a clean v0.4 baseline. |
...
| 4 | v04_meta_collection_loadout_prompt.md | blocked until #1 | any | Completes collection loadout, run injection, and failure usage decay. |
| 5 | v04_meta_collection_economy_polish_prompt.md | blocked until #4 | any | Adds pawn sale, trade-up, gold usefulness, collection browser controls, and reveal polish. |
| 6 | profile_persistence_completion_prompt.md | blocked until #1 and #5 | any | Parked T5.3: run history, daily streaks, lifetime stats, challenge display, schema/atomic profile save. |

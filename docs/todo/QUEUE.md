...
| 2 | playtest_root_fix_agent_prompt.md | claimed (2026-07-06, Codex desktop session; user override) | PM machine | Executing now; preserve in-progress dirty-tree work |

...
| Gate | Exact command/build | Result | Evidence |
| --- | --- | --- | --- |
| | | | |
...
- Named routes/seeds exercised:
- Windows hands-on result:
- Web hands-on result:
- Final capture inventory with what each image proves:
- Accepted limitations and owner references:

## Artifact identity

| Artifact | Source hash | Size | SHA-256 | Hands-on result |
| --- | --- | ---: | --- | --- |
| | | | | |

## Owner gates and publication
...
Use `CANDIDATE VERIFIED`, `APPROVED FOR RELEASE`, or `RELEASED` only when the
corresponding evidence and owner actions above exist. Reconcile source,
artifacts, hashes, tag and public records before the final state.

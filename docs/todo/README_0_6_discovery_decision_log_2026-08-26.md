...
| `content06_1/release06_1` | 1 | `[content06_1/release06_1]` |
| `craps06_1` | 5 | `[craps06_1]` |
| `craps06_2` | 1 | `[craps06_2]` |
| `craps06_3` | 1 | `[craps06_3]` |
| `crew06_10` | 1 | `[crew06_10]` |
| `crew06_2` | 1 | `[crew06_2]` |
| `crew06_2/crew06_3` | 2 | `[crew06_2/crew06_3]` |
| `crew06_3` | 1 | `[crew06_3]` |
| `crew06_5` | 3 | `[crew06_5]` |
| `crew06_5 final scope/design review` | 1 | `[crew06_5 final scope/design review]` |
| `crew06_5 voice review` | 1 | `[crew06_5 voice review]` |
| `crew06_5/integrated UI` | 2 | `[crew06_5/integrated UI]` |
| `crew06_6/crew06_7` | 1 | `[crew06_6/crew06_7]` |
| `crew06_8` | 7 | `[crew06_8]` |
| `crew06_8/content06_1` | 1 | `[crew06_8/content06_1]` |
| `crew06_9` | 5 | `[crew06_9]` |
| `env06_1/town06_1` | 1 | `[env06_1/town06_1]` |
| `env06_2` | 3 | `[env06_2]` |
| `env06_2/env06_4` | 1 | `[env06_2/env06_4]` |
| `env06_3` | 1 | `[env06_3]` |
| `env06_3/town06_3` | 1 | `[env06_3/town06_3]` |
| `env06_4` | 4 | `[env06_4]` |
| `env06_6/env06_7` | 1 | `[env06_6/env06_7]` |
| `fix06_1` | 3 | `[fix06_1]` |
| `fix06_2` | 5 | `[fix06_2]` |
| `fix06_2/crew06_5 determinism` | 1 | `[fix06_2/crew06_5 determinism]` |
| `fix06_2/crew06_5 integrated UI` | 1 | `[fix06_2/crew06_5 integrated UI]` |
...
| `push06_1` | 6 | `[push06_1]` |
| `pusher` | 2 | `[pusher]` |
| `pusher06_2` | 7 | `[pusher06_2]` |
| `pusher06_2 4.6 binding pin` | 3 | `[pusher06_2 4.6 binding pin]` |
| `pusher06_2 density authority` | 1 | `[pusher06_2 density authority]` |
| `pusher06_2 embedded-refresh acceptance` | 1 | `[pusher06_2 embedded-refresh acceptance]` |
| `pusher06_2 export parity` | 1 | `[pusher06_2 export parity]` |
| `pusher06_2 feel verdict` | 1 | `[pusher06_2 feel verdict]` |
| `pusher06_2 final performance` | 1 | `[pusher06_2 final performance]` |
| `pusher06_2 host root analysis` | 1 | `[pusher06_2 host root analysis]` |
| `pusher06_2 input scope` | 1 | `[pusher06_2 input scope]` |
| `pusher06_2 interrupt fast-path acceptance` | 1 | `[pusher06_2 interrupt fast-path acceptance]` |
| `pusher06_2 interrupt fast-path review` | 1 | `[pusher06_2 interrupt fast-path review]` |
| `pusher06_2 kernel parity` | 2 | `[pusher06_2 kernel parity]` |
| `pusher06_2 native adapter` | 3 | `[pusher06_2 native adapter]` |
| `pusher06_2 native boundary` | 1 | `[pusher06_2 native boundary]` |
| `pusher06_2 native hardening` | 2 | `[pusher06_2 native hardening]` |
| `pusher06_2 native host split` | 1 | `[pusher06_2 native host split]` |
| `pusher06_2 native load` | 1 | `[pusher06_2 native load]` |
| `pusher06_2 native optimization review` | 1 | `[pusher06_2 native optimization review]` |
| `pusher06_2 native performance` | 1 | `[pusher06_2 native performance]` |
| `pusher06_2 native phase profile` | 1 | `[pusher06_2 native phase profile]` |
| `pusher06_2 native static acceptance` | 1 | `[pusher06_2 native static acceptance]` |
| `pusher06_2 opening density` | 1 | `[pusher06_2 opening density]` |
| `pusher06_2 optimized native profile` | 1 | `[pusher06_2 optimized native profile]` |
| `pusher06_2 presentation closeout` | 1 | `[pusher06_2 presentation closeout]` |
| `pusher06_2 presentation gaps` | 1 | `[pusher06_2 presentation gaps]` |
| `pusher06_2 presentation runtime` | 1 | `[pusher06_2 presentation runtime]` |
| `pusher06_2 trace audit` | 1 | `[pusher06_2 trace audit]` |
| `pusher06_2 Web diagnostic` | 1 | `[pusher06_2 Web diagnostic]` |
| `pusher06_2 Windows native` | 1 | `[pusher06_2 Windows native]` |
| `pusherv3_1` | 5 | `[pusherv3_1]` |
| `pusherv3_2` | 10 | `[pusherv3_2]` |
| `pusherv3_2/content06_1` | 1 | `[pusherv3_2/content06_1]` |
| `pusherv3_3` | 4 | `[pusherv3_3]` |
| `pusherv3_4` | 3 | `[pusherv3_4]` |
| `pusherv3_4/content06_1` | 1 | `[pusherv3_4/content06_1]` |
| `rework06_2` | 2 | `[rework06_2]` |
| `streets06_1` | 4 | `[streets06_1]` |
| `streets06_1/crew06_3` | 3 | `[streets06_1/crew06_3]` |
| `systems gate` | 7 | `[systems gate]` |
| `teach06_1` | 2 | `[teach06_1]` |
| `town06_1` | 1 | `[town06_1]` |
| `town06_2` | 1 | `[town06_2]` |
| `town06_2/env06_2` | 1 | `[town06_2/env06_2]` |
| `town06_2/town06_3` | 1 | `[town06_2/town06_3]` |
| `town06_3` | 2 | `[town06_3]` |
| `Wave A gates` | 2 | `[Wave A gates]` |
| `Wave C` | 1 | `[Wave C]` |
| `Wave C acceptance` | 3 | `[Wave C acceptance]` |
...
- 2026-08-26 [board06_1] Owner-question audit found shipped code answers Chip
  Dump without a separate ruling: `data/crew/plays.json` implements model A as
  a player-funded 40 cash-to-chips transfer with a 6 fee, and explicitly says
  detection preserves laundering risk and never creates value. The
  pusherv3_10 support/cup question is also answered by the owner's recorded
  direction and production `support_ids`, landing-quality, consumed-cup and
  same-source-nozzle paths. Every other question already carries an ANSWERED
  ruling; none was closed by inference.

- 2026-08-26 [board06_1] The quiet-window structural pass moved all 170
  Discovery & Decision entries and all 124 Work entries verbatim into dated
  companions, leaving live task state, the binding protocol and current owner
  verdicts on the active board. The superseded pusher rows and the useful
  `art06_1` false-premise finding moved intact to a non-claimable archive.

- 2026-08-26 [board06_1] Clean isolated-tree orphan scan found no `.uid` whose
  source is absent. The specifically named ignored
...
* 2026-08-27 — `program06_0` BINDING CROSS-ROW OWNERSHIP: the future `game06_1` implementation/Family 1 shared-runtime integrator is sole writer through `game06_7` for `data/games/games.json`, `check_table_games.gd`, and master table-game probes; consumer squads provide patch manifests/row-local fixtures. The `env06_7` assembly owner is sole writer for the five cross-seam fixtures, combined scenario dossiers/catalog/index files, and `pixel_scene_canvas.gd`; package, craps, and poker squads provide seam manifests. `crew_poker_model.gd` remains exclusively in the parallel former-PM crew/world lane. Shared audio manifest/routing changes remain exclusive to `audio06_1`; depth rows may emit existing semantic cues only. These assignments resolve ownership hazards and do not block row-local audits/tests.
* 2026-09-01 — `[fix06_8]` OWNER RULING APPLIED: response `1` selects the fixed deterministic production control/nozzle trace. The trace may use an authored nozzle selection and production skill-stop phase alignment, but may not seed-search, control-search, insert a synthetic body, weaken physical adjacency, or accept an unnamed neighbor. All three production cabinets pass that exact interpretation.
* 2026-09-02 — `[game06_3]` FINAL D3 DISPOSITION: current `main` contains both preserved full Roulette depth and completed full Baccarat depth, and the owner directed this recommended closeout to completion. The delivered state therefore satisfies the earlier full-closure option directly; no requirement reduction, exception, or split `game06_3b` successor is necessary. Stale audits were corrected to call the real sealed host boundary, not the intentionally observational compatibility shim. The unchanged aggregate performance probe's unrelated Coin Pusher red is retained and does not become a Roulette/Baccarat defect.
* 2026-09-02 — `[game06_6]` CRAPS SEAM DISPOSITION: the landed `craps06_3_environment_binding.gd` adapter proves Craps ownership and correctly rejects foreign producer/game/table identities, so Bar Dice must not forge that identity, call private Craps helpers, or duplicate sweep/refund/relocation authority. This is the dependency limitation contemplated by game06_6's explicit “file the finding with evidence” instruction. The accepted Bar Dice implementation remains fail-closed: only future already-authoritative public interruption facts may be projected, and they cannot mutate a live run. A reusable cross-game street adapter, if desired later, is owned outside game06_6 and is not a condition of this row's completion.
* 2026-09-02 — `[game06_7]` CLOSEOUT DISPOSITION: the recovered `a6e7be91` product is the authoritative depth implementation; the historical contract-only and replay manifests are superseded as intake status, not deleted. The row-owned dealt-hand persistence defect is corrected at `45e87257` without changing the duel ladder. The post-fix boss-objective run retains one environment-owned room-return seam and three obsolete receipt-free fabricated Blackjack result fixtures; the sealed host correctly rejects those fixtures. They remain visible for their owning rows and `game06_8`, while direct product, route, save/revisit, parity, determinism, performance, privacy, and visual evidence closes game06_7.
* 2026-09-06 — `[env06_8]` SECOND-REVIEW DISCOVERY: exact-head structural and hidden-information gates can be green while the row's visual consequence acceptance remains red. The retained production probe at `3621a696` records 127 failures across 53/55 scenarios: 45 unchanged settled-room rasters, three failed cue/event consumer receipts, 31 missing action-definition receipts, 27 missing before/after rasters, 12 missing created objects and nine projection failures. Candidate changes through `9c4196dd` alter only the motel cart in affected product data; the visual probe's functional logic is byte-equivalent, so the non-motel evidence was not invalidated. Independent review classified the remaining visual consequence and unlabeled-object identifiability gaps P1 and escalated after the row's second rejection.
* 2026-09-06 — `[env06_8]` ALTERNATE-CONTRACT DISPOSITION DEFAULT: `codex/closeout06-final` retains a different 815-line contract plus geometry, hidden-boundary and all-scenario capture checks, while the clean candidate uses a 1,057-line contract with different coverage. The owner question remains open. Per `closeout06_1`, the operative default is no port; the stale branch and its checks remain preserved and unmerged.

* 2026-09-14 — BRANCH-CUSTODY CORRECTION: the preceding preservation statement is historical. The owner retained the no-port decision, and the complete branch audit classified `codex/closeout06-final` as rejected/superseded and deleted it. Only `main` and `codex/wip-0.6-consolidated` now remain.
* 2026-09-06 — `[env06_8/env06_9]` OWNER RE-SCOPE: the visual findings were mechanically unreachable from `env06_8` because `pixel_scene_canvas.gd::_fallback_event_prop()` does not consume object `state`, while 462/827 object operations lack an authored `icon_key` and share a small fallback glyph vocabulary. The owner retained those findings in parked `env06_9` and re-scoped `env06_8` to structural playability. This is neither an exception nor a waiver; the re-scoped row starts at zero review rejections.
* 2026-09-06 — `[integ06_1/fix06_26]` HARNESS ROOT CAUSE / RECORD CORRECTION: any harness that travels must call `scenario_finalize_installed_environment()` on arrival exactly as the production host does. Adding the missing Punchline L1 call clears layer transition, made-rank, save/load and revisit cascades and exposes the populated L3 back room. The only remaining Wave B composition failure is empty Crew-favor candidate selection after a successful lender action, routed to timeboxed `fix06_26`.
* 2026-09-07 — `[fix06_26/integ06_1]` TIMEBOX DISPOSITION: the empty Crew-favor roll list had two independent authored gates: the three-person speaker defaulted to a room actor and was excluded at home/recovery, then the debt call was rejected by the quiet-visit budget. Setting `environment_actor=false` and `cadence.bypass_budget=true` makes the shipped home/action path shortlist, accept and queue the event. Continuing the previously red full composition probe then reached a distinct visited-scenario semantic-digest rejection after Crew-rank mutation. Because the owner explicitly deferred the full composition matrix and required this row to stay contained, that later failure is retained as a refinement finding rather than folded into `fix06_26` or represented as green.
* 2026-09-07 — `[playtest06_1]` FAST-PATH FINDINGS: eight full mouse routes passed from nine exercised. Seed `PLAYTEST06-1-FASTPATH-008` traveled through populated rooms but a physical-delivery handoff did not clear the active run and the broad QA route stopped; retain for refinement rather than misreporting 9/9. The Windows export produced and booted a valid executable, but `tools/export_itch.ps1`'s Windows assignment captured Godot stdout plus exit code and emitted a false-negative wrapper failure; `-SkipExport -NoPackage` then passed the native/runtime/output checks on the artifact. Neither finding expanded into deferred release work.
* 2026-09-10 — `[fix06_31]` BASELINE/AUDIT DISCOVERY: production-host enumeration found 1,437 location-bearing scenario records, including 228 `FLOATING`, 237 `WRONG_SURFACE`, 114 `SEMANTIC_MISMATCH`, and 95 deduplicated person-placement root causes. Punchline, Delta Queen, Bar, Kitty Cat Lounge, Jazz Club, Gas Station, and Motel were the worst rooms. The broader recursive census exceeds the prompt's narrower snapshot because it includes retained location metadata in pose/behavior/state/remove receipts; neither count was rewritten to force agreement.
* 2026-09-10 — `[fix06_31]` SURFACE/CLASSIFIER DECISION: all 18 archetypes and the three Punchline layers use explicit art-derived floor, counter, seat, wall, ceiling, doorway, and void maps. One pure `EnvironmentPlacement.classify()` function owns the 10 placement classes; the audit's provisional duplicate heuristic was removed. The permanent static gate rejects missing maps/classes, malformed or off-board authored geometry, duplicate surfaces, and any classifier RNG or wall-clock input.
* 2026-09-10 — `[fix06_31]` RETAINED BASELINE RED: the pre-change determinism wrapper reached the current Hold'em game through a stale `crew_draw_poker/call` driver and failed on the current ordered-turn/buy-in contract. The row will repair only that test driver's legal action route before its required before/after determinism comparison; game rules, RNG, economy, payouts, and save schema remain out of scope.
* 2026-09-11 — `[fix06_31]` OWNER CORRECTION / SOLVER DISPOSITION: the generic whole-board solver was preserved at `ff1e5e0f` and removed from the shipping path. Final placement keeps valid authored coordinates, uses bounded local class-valid offsets only as a safety net, and falls back to authored room/class slots. The corrected person classifier exposed 39 `FLOATING` and 183 `WRONG_SURFACE` records out of 932 in the rejected interim audit; shopkeepers, merchants, lenders, named people, Silas and person props now classify as people. No further profiling was run after the owner's stop instruction.
* 2026-09-11 — `[fix06_31]` FINAL PLACEMENT DECISION: every reachable scenario phase was hand-authored room by room against the 21 surface maps, including rotating event/lender/item inventories. The production-host capture records 1,022/1,022 objects `OK` with zero floating roots or failures, and all 13 contact sheets were visually reviewed. The exact 440/440 gate covers 17,984 reachable states and 3,768 distinct layouts without deleting or hiding content; 1,108 object ops, 673 actions, 25 barrier objects and 39 barrier placements remain unchanged.
* 2026-09-11 — `[fix06_31]` DETERMINISM DRIVER DISPOSITION: the current Hold'em generator expands candidate membership when fewer than three residents are supplied, so the old two-resident probe could randomly seat no associate and could not legally deal. Isolated test-only commits now provide three associated residents and drive only current legal actions. Both ten-seed runs pass 642 checkpoints with combined hash `871972474` and byte-identical reports; game rules and RNG assertions are unchanged.
* 2026-09-12 — `[feat06_1]` MECHANIC DECISIONS: the owner's “8%” ships as eight integer heat points on the current location's 0–100 meter. The reward ships at a declared 33% action-boundary run-RNG chance; the checked-in low-tier rule is a sorted ordinary permanent/temporary sellable-item pool with positive buy range and `sale_price` 1–8, excluding owned and challenge-disabled items. A scalper has a named 20% deterministic chance to arrive after an eligible restock lands; that boundary is not intercepted, while later boundaries retain existing interception. One gift per persisted `scalper_visit_token` is mandatory.
* 2026-09-12 — `[feat06_1]` TRANSIT/PERFORMANCE DECISIONS: mid-visit people reuse actor routes over the nearest authored doorway and floor band; room entry, reload, reduced motion, and deterministic overflow settle immediately. Arrivals are not clickable until settled and departures stop being clickable at departure start. The cap is eight concurrent transits in sorted object-id order. A 240-frame same-room sample measured idle 0.674 ms average/0.736 ms p95 and active 0.715 ms average/1.881 ms p95 (+0.042 ms average), with 13 independent idle-liveness redraws.

...
| 1–5 | rw06_2 | `rw06_2_three_endings_prompt.md` | rw06_0 (runs parallel to rw06_1; final pass after rw06_1) | IN_PROGRESS (the sixth Clean replay-only blocker is fixed at product commit `48cc7dc7` / pushed tip `7af48369`; exact dialog controls now receive real input through their owning Window viewport; probe 7 has the serialized Godot lease and qualifying routes wait for rw06_1) |

...
| 1–5 | rw06_2 | `rw06_2_three_endings_prompt.md` | rw06_0 (runs parallel to rw06_1; final pass after rw06_1) | IN_PROGRESS (first Clean replay-policy blocker fixed at `760bdf4c`; second probe reached action 4 and exposed a public scroll-bridge gap, not a product arc; narrow fix in progress while qualifying routes wait for rw06_1) |

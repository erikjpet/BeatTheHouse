...
| 1–5 | rw06_2 | `rw06_2_three_endings_prompt.md` | rw06_0 (runs parallel to rw06_1; final pass after rw06_1) | IN_PROGRESS (first Clean probe's replay-policy blocker fixed at pushed tip `760bdf4c`; source contract and full engine-free validation pass; second non-qualifying probe running while qualifying routes wait for rw06_1) |

...
| 1–5 | rw06_2 | `rw06_2_three_endings_prompt.md` | rw06_0 (runs parallel to rw06_1; final pass after rw06_1) | IN_PROGRESS (the first five Clean replay-policy blockers are fixed through product commit `2f0655c2` / pushed tip `05ffb8db`; the exact tutorial confirmation controls are now public to the replay harness and one serialized proof probe is running; qualifying routes wait for rw06_1) |

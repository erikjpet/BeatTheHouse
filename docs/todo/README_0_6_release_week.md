...
| 1–5 | rw06_2 | `rw06_2_three_endings_prompt.md` | rw06_0 (runs parallel to rw06_1; final pass after rw06_1) | IN_PROGRESS (probe 7 at pushed tip `7af48369` proved the exact OK identity but exposed a second harness-only embedded-Window coordinate route at action 8; the narrow embedder-coordinate fix is in progress without Godot and qualifying routes wait for rw06_1) |

...
| 1–4 | rw06_1 | `rw06_1_fixed_slot_rooms_prompt.md` | rw06_0 | IN_PROGRESS (pushed core checkpoint `1ef797f8`; the compact overflow panel/input and Back Alley ship cap are repaired engine-free, while the semantic authority fix remains on its side branch; Corner Store/Bar/Grand Casino still await a successful 3/3 capture and Q-004 gave no approval; all-map authoring continues; land on `main` by end of 2026-09-24) |

...
const CONFIGS := [
	...
	{"id":"jazz_club_guest_legend","archetype":"jazz_club","arrival":"A reserved guest table blocks the stage stair while an empty instrument stand waits backstage.","verbs":["find_instrument_case","open_backstage_lane","inspect_missing_piece","prepare_missing_cue","reorder_set_cards","time_guest_reveal"],"beats":["case_move","stage_state"],"fact":"travel_arrived","tags":["instrument_retrieval","reveal_timing","set_reorder"],"objects":[["guest_table","Reserved legend table","furniture","center","reserved"],["instrument_case","Instrument case","instrument","left","latched"],["cue_stand","Empty cue stand","performance","background","waiting"]],"actors":[["guest_legend","Guest legend","actor_guest_legend","right","watch"],["stage_manager","Stage manager","actor_stage_manager","background","work"]],"outcomes":["legend_revealed","cue_missed","guest_withheld","arrival_interrupted"]},

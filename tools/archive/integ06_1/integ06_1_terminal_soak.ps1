...
$projectText = (Get-Content -LiteralPath $projectPath -Raw).Replace('run/main_scene="res://scenes/main.tscn"', 'run/main_scene="res://tools/archive/integ06_1/integ06_1_terminal_soak_main.tscn"')
if (-not $projectText.Contains('run/main_scene="res://tools/archive/integ06_1/integ06_1_terminal_soak_main.tscn"')) { throw "Transient project main-scene replacement failed." }

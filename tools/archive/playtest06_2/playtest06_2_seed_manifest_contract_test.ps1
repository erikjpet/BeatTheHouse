...
try {
    ...
    $prestage = Invoke-Contract $sourceContract (Join-Path $sourceRoot "tools/archive/playtest06_2/playtest06_2_candidate_seeds.json")
    ...
    Copy-Item -LiteralPath $sourceContract -Destination (Join-Path $repo "tools/archive/playtest06_2/playtest06_2_seed_manifest_contract.ps1")
    $ownerTools = @("tools/archive/playtest06/playtest06_owner_build.ps1", "tools/export_itch.ps1", "tools/build_native_solver.ps1", "tools/verify_native_solver_runtime.ps1", "tools/web_perf_smoke.ps1", "tools/web_perf_export_mode.ps1", "tools/export_tree_identity.ps1", "tools/archive/l02/l02_web_perf_probe.mjs", "tools/serve_web.ps1")
    ...
    $build = [ordered]@{
        ...
        builder_script_sha256 = Get-Hash (Join-Path $repo "tools/archive/playtest06/playtest06_owner_build.ps1")
    ...
    $sandboxContract = Join-Path $repo "tools/archive/playtest06_2/playtest06_2_seed_manifest_contract.ps1"

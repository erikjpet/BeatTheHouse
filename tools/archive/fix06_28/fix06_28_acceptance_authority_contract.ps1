...
$legacySurfacePath = Join-Path $ProjectRoot 'tools/archive/playtest06/playtest06_surface_family_playability_contract.gd'
...
$workingOrderPath = Join-Path $ProjectRoot 'tools/archive/fix06_28/fix06_28_working_order_driver.gd'

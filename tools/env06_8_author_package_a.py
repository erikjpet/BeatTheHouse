...
COPY = {
    ...
    "inventory_clerk": ("The inventory clerk guards the pencil marks, knowing a careless recount could hide the shortage.", {"service_lane": "The clerk takes the counter side of the cage and leaves the customer lane open.", "recounting_shelf": "The clerk calls each shelf tag aloud and waits for the count to match."}, "background"),
    ...
    "estate_appraiser": ("The appraiser handles every piece in view, making quiet substitutions difficult.", {"comparing_marks": "The appraiser compares the faded marks against the estate sheet line by line.", "guard": "The appraiser now guards the matched lot until its disposition is settled.", "foreground": "The appraiser stands with the provenanced pieces at the front of the station."}, "service_lane"),

...
func _entry(c: Dictionary) -> Dictionary:
	...
	var sequence := {
		...
		"declared_targets":{"scene_objects":[],"interactions":[],"actors":[],"services":[],"games":[],"routes":[],"anchors":["base::anchor:delivery_manifest"] if c.has("object_a_anchor") else [],"zones":["base::zone:left","base::zone:right","base::zone:center","base::zone:background","base::zone:service_lane","base::zone:foreground","base::zone:exit_lane"]}
	}
...
func _phase_arrival(c: Dictionary) -> Dictionary:
	...
	var primary := _spawn(sid+"_arrival_a",c.object_a,_label(c.object_a),"primary_task",str(c.get("object_a_zone", "left")),"arrival")
	if c.has("object_a_anchor"):
		primary["object"]["anchor_id"] = str(c.object_a_anchor)
		primary["object"].erase("zone_id")
	var scene_ops := [primary,_spawn(sid+"_arrival_b",c.object_b,_label(c.object_b),"evidence","right","unread")]
	if bool(c.get("seal_exit_visual", false)):
...
func _target_inventory() -> Dictionary:
	return {"scene_objects":[],"interactions":[],"actors":[],"services":[],"games":[],"routes":[],"anchors":["base::anchor:delivery_manifest"],"zones":["base::zone:left","base::zone:right","base::zone:center","base::zone:background","base::zone:service_lane","base::zone:foreground","base::zone:exit_lane"],"event_choices":{}}

...
const SPATIAL_BINDINGS := {
	...
	"punchline_debt_court":{"layer":"back_room","anchors":["punchline_debt_hearing_chairs","punchline_debt_room_witness"],"route":"base::layer:club"},
	...
	"punchline_raid_jitters":{"layer":"back_room","anchors":["punchline_raid_hide_cart","punchline_raid_reopen_steward"],"route":"base::layer:club"},

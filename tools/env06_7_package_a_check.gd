...
func _init() -> void:
	...
	for entry_value in entries:
		...
		if scenario_id != "corner_store_delivery_day":
			for error_value in SequenceSchema.validate_definition(definition, OperationRegistry, _dict(_host_semantics().target_inventory)): failures.append("%s: %s" % [scenario_id,error_value])
...
func _host_semantics() -> Dictionary:
	return {"target_inventory":{"scene_objects":[],"interactions":[],"actors":[],"services":[],"games":[],"routes":[],"anchors":[],"zones":["base::zone:left","base::zone:right","base::zone:center","base::zone:background","base::zone:service_lane","base::zone:foreground","base::zone:exit_lane"],"event_choices":{}},"inventory_schema_version":1,"inventory_digest":"package_a_fixture_inventory","inventory_errors":[],"base_interactions":[],"event_choices":{}}

...
Require-Text "tools/check_godot.ps1" 'Initialize-FoundationSplitRunner' "Godot check script must prepare the split foundation check runner."
Require-Text "tools/check_godot.ps1" 'Get-VerifiedFoundationSplitRunnerPath' "Godot check script must verify the prepared split foundation check runner before use."

...
Require-Text "tools/check_godot.ps1" 'function Invoke-TerminalSoakLauncherContract' "Godot checks must expose the exact-candidate terminal-soak launcher contract."
Require-Text "tools/check_godot.ps1" 'Invoke-TerminalSoakLauncherContract' "Godot Audit/Full must run the exact-candidate terminal-soak launcher contract."
Require-Text "tools/check_godot.ps1" 'integ06_1_terminal_soak_launcher_contract_test.ps1' "Godot Audit/Full must retain exact-candidate terminal-soak host-library discovery."
